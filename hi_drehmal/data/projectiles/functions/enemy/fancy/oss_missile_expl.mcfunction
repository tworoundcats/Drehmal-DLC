...
execute at @s run execute if score #DLC mastermode matches 1 as @a[distance=..1] run damage @s 12 ossein/bathed
execute at @s run execute unless score #DLC mastermode matches 1 as @a[distance=..1] run damage @s 6 ossein/bathed
