...
execute as @a[distance=..1] unless entity @s[scores={blocking3=..4,blocked=1..}] run damage @s 7 khivewrath by @e[tag=mb_run_skele,limit=1,sort=nearest]
execute as @a[distance=..1] if entity @s[scores={blocking3=..4,blocked=1..}] run function players:items/reticent/main