...
execute at @s if score @s[tag=!asc_beam2] time_limit matches 0 run function projectiles:out_of_time
execute at @s if score @s[tag=!asc_beam2] time_limit matches ..-200 run function projectiles:out_of_time

execute at @s if score @s[tag=asc_beam2] time_limit matches 0 run function projectiles:out_of_time2
execute at @s if score @s[tag=asc_beam2] time_limit matches ..-200 run function projectiles:out_of_time2
