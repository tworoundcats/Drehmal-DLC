...
execute as @s[type=!#core:avgun_medium,type=!#core:avgun_big,type=!#core:avgun_massive] run damage @s[scores={blocking3=..4,blocked=1..}] 0.45 avrad

#-----------damage for specific entities-------------#
execute as @s[type=#core:avgun_medium] run damage @s[scores={blocking3=..4,blocked=1..}] 0.3 avrad
execute as @s[type=#core:avgun_big] run damage @s[scores={blocking3=..4,blocked=1..}] 0.225 avrad
execute as @s[type=#core:avgun_massive] run damage @s[scores={blocking3=..4,blocked=1..}] 0.175 avrad
execute as @s[type=ender_dragon] run damage @s[scores={blocking3=..4,blocked=1..}] 0.01 avrad by @p
