...
data merge entity @s {Health:24.0f,IsImmuneToZombification:1b,DeathLootTable:"spm:death/bastion_guard",IsBaby:0b,CustomName:'{"text": "Bastion Guard","color": "dark_gray","italic": false}',CustomNameVisible:0b}
