...
execute positioned 505.51 67.00 1835.52 as @e[name="Stablemaster Keehko",type=villager,tag=!qend,tag=!tempd] if entity @a[distance=..3,tag=qst,tag=!qst_e] if entity @e[type=horse,tag=Eddie,distance=..5] run function quests:keekoquest/finish
...
execute positioned -2979.47 141.00 -159.46 as @e[name="Muhton",type=villager,tag=goldblock,tag=!qend] if entity @a[distance=..3,tag=qst6,tag=!qst6_e] run execute positioned ~ ~ ~ as @p[tag=qst6] if predicate players:holding/quest/goldblock run function quests:moutonquest/gold_detect
execute positioned -2979.47 141.00 -159.46 as @e[name="Muhton",type=villager,tag=reddye,tag=!qend] if entity @a[distance=..3,tag=qst6,tag=!qst6_e] run execute positioned ~ ~ ~ as @p[tag=qst6] if predicate players:holding/quest/reddye run function quests:moutonquest/red_detect
execute positioned -2979.47 141.00 -159.46 as @e[name="Muhton",type=villager,tag=torahn,tag=!qend] if entity @a[distance=..3,tag=qst6,tag=!qst6_e] run execute positioned ~ ~ ~ as @p[tag=qst6] if predicate players:holding/quest/pufferfish run function quests:moutonquest/torahn_detect
execute positioned -2979.47 141.00 -159.46 as @e[name="Muhton",type=villager,tag=runic,tag=!qend] if entity @a[distance=..3,tag=qst6,tag=!qst6_e] run execute positioned ~ ~ ~ as @p[tag=qst6] if predicate players:holding/quest/runiccat run function quests:moutonquest/runic_detect
...
# Russell - Mohta
execute positioned 31.48 67.00 5263.55 if entity @e[name="Russell",type=villager,distance=..3,tag=book1_read,tag=book2_read,tag=book3_read,tag=book4_read,tag=book5_read,tag=book6_read,tag=book7_read,tag=book8_read] run execute as @e[type=villager,name="Russell"] run tag @s add allbooksread
execute positioned 31.48 67.00 5263.55 as @e[name="Russell",type=villager,tag=allbooksread,distance=..3] if entity @a[distance=..4,tag=!nomorebooks_heard] run function quests:russellquest/nomorebooks
execute positioned 31.48 67.00 5263.55 as @e[name="Russell",type=villager,tag=!qend,tag=wantsbook1,distance=..3] if entity @a[distance=..3,tag=qst11] run execute positioned ~ ~ ~ as @p[tag=qst11,tag=!qst11_e] if predicate players:holding/quest/russellbook1 run function quests:russellquest/muhs_done1
execute positioned 31.48 67.00 5263.55 as @e[name="Russell",type=villager,tag=!qend,tag=wantsbook2,distance=..3] if entity @a[distance=..3,tag=qst11] run execute positioned ~ ~ ~ as @p[tag=qst11,tag=!qst11_e] if predicate players:holding/quest/russellbook2 run function quests:russellquest/aok_done1
execute positioned 31.48 67.00 5263.55 as @e[name="Russell",type=villager,tag=!qend,tag=wantsbook3,distance=..3] if entity @a[distance=..3,tag=qst11] run execute positioned ~ ~ ~ as @p[tag=qst11,tag=!qst11_e] if predicate players:holding/quest/russellbook3 run function quests:russellquest/worm_done1
execute positioned 31.48 67.00 5263.55 as @e[name="Russell",type=villager,tag=!qend,tag=wantsbook4,distance=..3] if entity @a[distance=..3,tag=qst11] run execute positioned ~ ~ ~ as @p[tag=qst11,tag=!qst11_e] if predicate players:holding/quest/russellbook4 run function quests:russellquest/homli_done1
execute positioned 31.48 67.00 5263.55 as @e[name="Russell",type=villager,tag=!qend,tag=wantsbook5,distance=..3] if entity @a[distance=..3,tag=qst11] run execute positioned ~ ~ ~ as @p[tag=qst11,tag=!qst11_e] if predicate players:holding/quest/russellbook5 run function quests:russellquest/xiv_done1
execute positioned 31.48 67.00 5263.55 as @e[name="Russell",type=villager,tag=!qend,tag=wantsbook6,distance=..3] if entity @a[distance=..3,tag=qst11] run execute positioned ~ ~ ~ as @p[tag=qst11,tag=!qst11_e] if predicate players:holding/quest/russellbook6 run function quests:russellquest/klyhf_done1
execute positioned 31.48 67.00 5263.55 as @e[name="Russell",type=villager,tag=!qend,tag=wantsbook7,distance=..3] if entity @a[distance=..3,tag=qst11] run execute positioned ~ ~ ~ as @p[tag=qst11,tag=!qst11_e] if predicate players:holding/quest/russellbook7 run function quests:russellquest/art_done1
execute positioned 31.48 67.00 5263.55 as @e[name="Russell",type=villager,tag=!qend,tag=wantsbook8,distance=..3] if entity @a[distance=..3,tag=qst11] run execute positioned ~ ~ ~ as @p[tag=qst11,tag=!qst11_e] if predicate players:holding/quest/russellbook8 run function quests:russellquest/dusty_done1
execute positioned 31.48 67.00 5263.55 as @e[name="Russell",type=villager,tag=!qstart,tag=!qend,tag=!allbooksread,distance=..3] if entity @a[distance=..3,tag=!qst11,tag=!qst11_e] run function quests:russellquest/base
execute positioned 31.48 67.00 5263.55 as @e[name="Russell",type=villager,tag=!qend,distance=..3] unless entity @a[distance=..3] run tag @s remove qstart
...
execute positioned -2719.50 64.00 -1641.50 as @e[name="Rift Technician",type=villager] if entity @a[distance=..3,tag=!hasriftmerch,tag=!riftmerchtarget] run execute positioned ~ ~ ~ as @p if predicate players:holding/quest/merch run function quests:riftquest/merch
...
execute positioned -2719.50 65.50 -1635.50 as @e[tag=emmisary_ball1,type=marker] if entity @a[distance=..1] run execute as @p[distance=..3,tag=!qst12_e] unless score #DLC repeatable matches 1 if predicate players:wearing_riftboots run function quests:riftquest/rifttp
execute positioned -2719.50 65.50 -1635.50 as @e[tag=emmisary_ball1,type=marker] if entity @a[distance=..1] run execute as @p[distance=..3,tag=!qst12_e] if score #DLC repeatable matches 1 if predicate players:wearing_riftboots run function quests:riftquest/rifttp_r
execute positioned -2719.50 65.50 -1635.50 as @e[tag=emmisary_ball1,type=marker] if entity @a[distance=..1] run execute as @p[distance=..3,tag=qst12_e] if predicate players:wearing_riftboots run function quests:riftquest/rifttp_f
...
execute positioned -2167.55 65.00 3701.51 as @e[name="Daniel",type=villager,tag=!qend,tag=orbcollecting,tag=!taihgel_rec,tag=!temp_speaking] if entity @a[distance=..2,tag=qst13] run execute positioned ~ ~ ~ as @p[tag=qst13] if predicate players:holding/quest/daniel/taihgelorb run function quests:danielquest/taihgel_detect
execute positioned -2167.55 65.00 3701.51 as @e[name="Daniel",type=villager,tag=!qend,tag=orbcollecting,tag=!rihelma_rec,tag=!temp_speaking] if entity @a[distance=..2,tag=qst13] run execute positioned ~ ~ ~ as @p[tag=qst13] if predicate players:holding/quest/daniel/rihelmaorb run function quests:danielquest/rihelma_detect
execute positioned -2167.55 65.00 3701.51 as @e[name="Daniel",type=villager,tag=!qend,tag=orbcollecting,tag=!mael_rec,tag=!temp_speaking] if entity @a[distance=..2,tag=qst13] run execute positioned ~ ~ ~ as @p[tag=qst13] if predicate players:holding/quest/daniel/maelorb run function quests:danielquest/mael_detect
execute positioned -2167.55 65.00 3701.51 as @e[name="Daniel",type=villager,tag=!qend,tag=orbcollecting,tag=!loe_rec,tag=!temp_speaking] if entity @a[distance=..2,tag=qst13] run execute positioned ~ ~ ~ as @p[tag=qst13] if predicate players:holding/quest/daniel/loeorb run function quests:danielquest/loe_detect
execute positioned -2167.55 65.00 3701.51 as @e[name="Daniel",type=villager,tag=!qend,tag=orbcollecting,tag=!lai_rec,tag=!temp_speaking] if entity @a[distance=..2,tag=qst13] run execute positioned ~ ~ ~ as @p[tag=qst13] if predicate players:holding/quest/daniel/laiorb run function quests:danielquest/lai_detect
execute positioned -2167.55 65.00 3701.51 as @e[name="Daniel",type=villager,tag=!qend,tag=orbcollecting,tag=!khive_rec,tag=!temp_speaking] if entity @a[distance=..2,tag=qst13] run execute positioned ~ ~ ~ as @p[tag=qst13] if predicate players:holding/quest/daniel/khiveorb run function quests:danielquest/khive_detect
execute positioned -2167.55 65.00 3701.51 as @e[name="Daniel",type=villager,tag=!qend,tag=orbcollecting,tag=!drehmal_rec,tag=!temp_speaking] if entity @a[distance=..2,tag=qst13] run execute positioned ~ ~ ~ as @p[tag=qst13] if predicate players:holding/quest/daniel/drehmalorb run function quests:danielquest/drehmal_detect
execute positioned -2167.55 65.00 3701.51 as @e[name="Daniel",type=villager,tag=!qend,tag=orbcollecting,tag=!dahr_rec,tag=!temp_speaking] if entity @a[distance=..2,tag=qst13] run execute positioned ~ ~ ~ as @p[tag=qst13] if predicate players:holding/quest/daniel/dahrorb run function quests:danielquest/dahr_detect
