...
scoreboard players reset #vol_church? bool
scoreboard players reset #mb_active bool
scoreboard players reset #wdespawn timer
scoreboard players reset #fdry_victory? bool
scoreboard players reset #trial_com_nums bool
scoreboard players reset #trial_com_nahyn bool
scoreboard players reset #trial_com_lai bool
scoreboard players reset #trial_com_khive bool
...
scoreboard players reset #game_started bool 
...
execute in minecraft:lodahr run fill -53 6 -1582 -53 6 -1584 air
execute in minecraft:lodahr run fill -54 5 -1584 -54 5 -1582 air
execute in minecraft:lodahr run fill -53 6 -1590 -53 6 -1592 air
execute in minecraft:lodahr run fill -54 5 -1592 -54 5 -1590 air
execute in minecraft:lodahr run fill -53 6 -1598 -53 6 -1600 air
execute in minecraft:lodahr run fill -54 5 -1598 -54 5 -1600 air
execute in minecraft:lodahr run fill -85 6 -1584 -85 6 -1582 air
execute in minecraft:lodahr run fill -84 5 -1582 -84 5 -1584 air
execute in minecraft:lodahr run fill -85 6 -1590 -85 6 -1592 air
execute in minecraft:lodahr run fill -84 5 -1592 -84 5 -1590 air
execute in minecraft:lodahr run fill -85 6 -1598 -85 6 -1600 air
execute in minecraft:lodahr run fill -84 5 -1600 -84 5 -1598 air
scoreboard players reset #teth_dead? bool
scoreboard players reset #myth_dia1 bool
scoreboard players reset #passive_can_spawn? bool
scoreboard players reset #bern_no_spawn? bool

scoreboard players reset #b.passive_alive? bool

scoreboard players reset #lodahr_beento bool
scoreboard players reset #some1_died bool
scoreboard players reset #space_beento bool
scoreboard players reset #mb_run_no_space bool
scoreboard players reset #mystery.meteor bool
scoreboard players reset #mystery.psoul bool
scoreboard players reset #mystery.mstoneall bool
scoreboard players reset #mystery.sol_mb bool
scoreboard players reset #mystery.sol_cal bool
scoreboard players reset #mystery.sol_asc bool
scoreboard players reset #mystery.sol_mal bool
scoreboard players reset #mystery.sol_obv bool
