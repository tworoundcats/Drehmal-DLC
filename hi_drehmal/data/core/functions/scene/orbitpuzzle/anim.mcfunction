...
#kill
execute if score #orbitpuzzle y matches 300 positioned 1233 127 310 as @a[distance=..5] unless entity @s[scores={blocking3=..4,blocked=1..}] run damage @s 40 minecraft:overreacted
execute if score #orbitpuzzle y matches 300 positioned 1233 127 310 as @a[distance=..5] if entity @s[scores={blocking3=..4,blocked=1..}] run function players:items/reticent/main
execute if score #orbitpuzzle y matches 300 positioned 1233 127 310 as @a[distance=..10] unless entity @s[scores={blocking3=..4,blocked=1..}] run damage @s 20 minecraft:overreacted
execute if score #orbitpuzzle y matches 300 positioned 1233 127 310 as @a[distance=..10] if entity @s[scores={blocking3=..4,blocked=1..}] run function players:items/reticent/main
execute if score #orbitpuzzle y matches 300 positioned 1233 127 310 as @a[distance=..20] unless entity @s[scores={blocking3=..4,blocked=1..}] run damage @s 10 minecraft:overreacted
execute if score #orbitpuzzle y matches 300 positioned 1233 127 310 as @a[distance=..20] if entity @s[scores={blocking3=..4,blocked=1..}] run function players:items/reticent/main
