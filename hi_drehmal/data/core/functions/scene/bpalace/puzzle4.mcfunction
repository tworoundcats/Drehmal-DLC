...
execute positioned -4045.44 91.21 5987.53 run execute as @a[distance=..1] unless entity @s[scores={blocking3=..4,blocked=1..}] run damage @s 15 in_fire
execute positioned -4045.44 91.21 5987.53 run execute as @a[distance=..1] if entity @s[scores={blocking3=..4,blocked=1..}] run function players:items/reticent/main
