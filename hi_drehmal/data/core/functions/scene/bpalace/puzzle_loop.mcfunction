...
execute if score #b_puzzle int matches 1.. positioned -4040.51 91.38 5989.49 run execute as @a[distance=..1] run damage @s[scores={blocking3=..4,blocked=1..}] 15 in_fire
execute if score #b_puzzle int matches 2.. positioned -4042.50 91.19 5990.44 run function particle:flame_beam/animate

execute if score #b_puzzle int matches 2.. positioned -4042.50 91.19 5990.44 run execute as @a[distance=..1] run damage @s[scores={blocking3=..4,blocked=1..}] 15 in_fire
...
execute if score #b_puzzle int matches 3.. positioned -4044.44 91.17 5989.48 run execute as @a[distance=..1] run damage @s[scores={blocking3=..4,blocked=1..}] 15 in_fire

execute if score #b_puzzle int matches 4.. positioned -4045.44 91.21 5987.53 run function particle:flame_beam/animate
execute if score #b_puzzle int matches 4.. positioned -4045.44 91.21 5987.53 run execute as @a[distance=..1] run damage @s[scores={blocking3=..4,blocked=1..}] 15 in_fire
...
execute if score #b_puzzle int matches 5.. positioned -4044.46 91.11 5985.56 run execute as @a[distance=..1] run damage @s[scores={blocking3=..4,blocked=1..}] 15 in_fire

execute if score #b_puzzle int matches 6.. positioned -4042.44 91.21 5984.54 run function particle:flame_beam/animate
execute if score #b_puzzle int matches 6.. positioned -4042.44 91.21 5984.54 run execute as @a[distance=..1] run damage @s[scores={blocking3=..4,blocked=1..}] 15 in_fire
...
execute if score #b_puzzle int matches 7.. positioned -4040.53 91.19 5985.56 run execute as @a[distance=..1] run damage @s[scores={blocking3=..4,blocked=1..}] 15 in_fire
