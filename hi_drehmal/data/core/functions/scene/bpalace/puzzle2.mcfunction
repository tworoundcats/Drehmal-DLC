...
execute positioned -4042.50 91.19 5990.44 run execute as @a[distance=..1] unless entity @s[scores={blocking3=..4,blocked=1..}] run damage @s 15 in_fire
execute positioned -4042.50 91.19 5990.44 run execute as @a[distance=..1] if entity @s[scores={blocking3=..4,blocked=1..}] run function players:items/reticent/main
