...
execute as @a[x=-2741, y=7 ,z=2116,dx=13,dy=4,dz=13] at @s if block ~ ~-0.25 ~ minecraft:yellow_stained_glass if score #5T timer matches 0 run damage @s[scores={blocking3=..4,blocked=1..}] 2 minecraft:moon/melt
