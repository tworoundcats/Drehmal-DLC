...
execute at @e[type=minecraft:marker,tag=asc_dmg] run execute as @e[type=!player,type=!#entities:dummy,type=!#entities:highcapacity,type=!#entities:proj,distance=..2] run damage @s[scores={blocking3=..4,blocked=1..}] 18 generic
kill @e[tag=asc_dmg]
