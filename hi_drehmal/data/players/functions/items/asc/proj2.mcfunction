...
playsound minecraft:dcustom.block.beacon.power_select player @a ~ ~ ~
...
summon marker ^-0.5 ^1 ^2 {Tags:["asc_beam2","fancy","proj","special","pierce","nomove","nobcollide","noecollide"]}
