...
execute if predicate players:holding/asc run setblock 1000000 16 1000000 furnace
...
#execute if entity @s[nbt={SelectedItem:{id:"minecraft:netherite_sword",Count:1b,tag:{display:{Name:"{\"text\":\"Ascendance ✪\",\"color\":\"gold\",\"italic\":false,\"underlined\":true}"}}}}] as @s[scores={asc_cd=70..}] run function players:items/asc/on_cd
