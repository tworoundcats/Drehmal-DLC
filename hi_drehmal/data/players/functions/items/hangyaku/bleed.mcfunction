...
execute as @s[scores={bleed=20}] run damage @s[scores={blocking3=..4,blocked=1..}] 5 in_fire
...
execute as @s[scores={bleed=40}] run damage @s[scores={blocking3=..4,blocked=1..}] 5 in_fire
...
execute as @s[scores={bleed=60}] run damage @s[scores={blocking3=..4,blocked=1..}] 5 in_fire
...
execute as @s[scores={bleed=80}] run damage @s[scores={blocking3=..4,blocked=1..}] 5 in_fire
...
execute as @s[scores={bleed=100}] run damage @s[scores={blocking3=..4,blocked=1..}] 5 in_fire
