...
execute as @s[scores={bleed=20}] run playsound minecraft:entity.blaze.hurt player @a ~ ~ ~ 1 0
...
execute as @s[scores={bleed=40}] run playsound minecraft:entity.blaze.hurt player @a ~ ~ ~ 1 0
...
execute as @s[scores={bleed=60}] run playsound minecraft:entity.blaze.hurt player @a ~ ~ ~ 1 0
...
execute as @s[scores={bleed=80}] run playsound minecraft:entity.blaze.hurt player @a ~ ~ ~ 1 0
...
execute as @s[scores={bleed=100}] run playsound minecraft:entity.blaze.hurt player @a ~ ~ ~ 1 0
