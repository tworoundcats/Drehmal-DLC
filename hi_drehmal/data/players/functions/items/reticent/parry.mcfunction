...
execute as @s[scores={repeatable=2..}] at @s unless entity @s[scores={blocking3=..4,blocked=1..}] run damage @s 8 generic by @p[tag=parrier,limit=1,sort=nearest]
execute as @s[scores={repeatable=2..}] at @s if entity @s[scores={blocking3=..4,blocked=1..}] run function players:items/reticent/main
