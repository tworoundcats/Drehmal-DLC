...
execute as @s if predicate players:sprint unless predicate players:slowness as @s run tag @s add sprint
execute if predicate players:slowness run tag @s remove sprint
