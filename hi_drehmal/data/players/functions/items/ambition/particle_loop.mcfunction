...
execute if score @s timer matches 21.. unless entity @e[tag=!mythic_pvp,predicate=!players:holding/ambition,predicate=!entities:invul,type=!#core:oblivion_immune,sort=nearest,limit=1,distance=..8] run particle enchanted_hit ~ ~ ~ 0.4 0.4 0.4 0 50 normal
execute if score @s timer matches 21.. unless entity @e[tag=!mythic_pvp,predicate=!players:holding/ambition,predicate=!entities:invul,type=!#core:oblivion_immune,sort=nearest,limit=1,distance=..8] run playsound minecraft:entity.generic.explode player @a ~ ~ ~ 1 2
execute if score @s timer matches 21.. unless entity @e[tag=!mythic_pvp,predicate=!players:holding/ambition,predicate=!entities:invul,type=!#core:oblivion_immune,sort=nearest,limit=1,distance=..8] run kill @s
