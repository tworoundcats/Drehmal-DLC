...
execute at @s as @e[tag=tagged2,tag=!tagged,type=!player,type=!#core:oblivion_immune,sort=nearest,limit=1,distance=..2.5] run damage @s[scores={blocking3=..4,blocked=1..}] 1.5 strangled by @p
execute at @s as @e[tag=!tagged2,tag=!tagged,type=!player,type=!#core:oblivion_immune,sort=nearest,limit=1,distance=..2.5] run damage @s[scores={blocking3=..4,blocked=1..}] 7 strangled by @p
