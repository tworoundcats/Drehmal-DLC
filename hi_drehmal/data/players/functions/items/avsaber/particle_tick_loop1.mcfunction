...
execute if score @s timer matches ..0 positioned ^ ^ ^5 facing entity @a[tag=zen,limit=1] eyes positioned ^ ^ ^0.02 facing entity @s eyes facing ^ ^ ^-1.6 positioned as @s run teleport @s ~ ~ ~ ~ ~
execute if score @s timer matches 1..3 positioned ^ ^ ^5 facing entity @a[tag=zen,limit=1] eyes positioned ^ ^ ^0.05 facing entity @s eyes facing ^ ^ ^-1.3 positioned as @s run teleport @s ~ ~ ~ ~ ~
execute if score @s timer matches 3..5 positioned ^ ^ ^5 facing entity @a[tag=zen,limit=1] eyes positioned ^ ^ ^0.11 facing entity @s eyes facing ^ ^ ^-0.7 positioned as @s run teleport @s ~ ~ ~ ~ ~
execute if score @s timer matches 6..9 positioned ^ ^ ^5 facing entity @a[tag=zen,limit=1] eyes positioned ^ ^ ^0.17 facing entity @s eyes facing ^ ^ ^-1.1 positioned as @s run teleport @s ~ ~ ~ ~ ~
execute if score @s timer matches 10..20 positioned ^ ^ ^5 facing entity @a[tag=zen,limit=1] eyes positioned ^ ^ ^0.24 facing entity @s eyes facing ^ ^ ^-1.5 positioned as @s run teleport @s ~ ~ ~ ~ ~
