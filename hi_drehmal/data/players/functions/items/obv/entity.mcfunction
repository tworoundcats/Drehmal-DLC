...
execute if entity @s[scores={ob_throw=..80}] as @s run execute as @e[type=!player,type=!#entities:dummy,type=!#entities:highcapacity,type=!#entities:proj,distance=..2] run damage @s[scores={blocking3=..4,blocked=1..}] 6 generic by @p[tag=ob_scythe]
...
execute if entity @s[scores={ob_passive=..8}] as @s run execute as @e[type=!player,type=!#entities:dummy,type=!#entities:highcapacity,type=!#entities:proj,distance=..2] run damage @s[scores={blocking3=..4,blocked=1..}] 0.5 generic by @p[tag=ob_scythe]
