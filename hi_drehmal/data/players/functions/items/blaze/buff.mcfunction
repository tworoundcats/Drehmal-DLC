...
execute as @s if predicate entities:on_fire at @s run effect give @s strength 1 0 true
execute as @s if predicate entities:on_fire at @s run effect give @s speed 1 0 true
execute as @s if predicate entities:on_fire at @s run effect give @s haste 1 0 true
