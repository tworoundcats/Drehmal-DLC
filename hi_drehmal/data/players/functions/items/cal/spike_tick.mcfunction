...
execute unless score @s timer matches 35.. at @s as @e[type=!player,type=!#entities:dummy,type=!#entities:tickless_passive,type=!#entities:highcapacity,type=!#entities:proj,distance=..1] run function players:items/cal/spike_damage
