...
execute as @e[type=!player,type=!#entities:dummy,type=!#entities:tickless_passive,type=!#entities:highcapacity,type=!#entities:proj,distance=..10] if predicate dlc:20 run effect give @s wither 3 0 true 
