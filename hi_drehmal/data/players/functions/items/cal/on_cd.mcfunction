...
execute as @e[type=#entities:hostile,distance=..10] if predicate dlc:20 run effect give @s extraalchemy:combustion 6 0 true 
execute as @e[type=#entities:hostile,distance=..10] if predicate dlc:10 run effect give @s extraalchemy:shrinking 1 0 true 
execute as @e[type=#entities:hostile,distance=..10] if predicate dlc:10 run effect give @s mcdar:stunned 3 0 true 
execute as @e[type=#entities:hostile,distance=..10] if predicate dlc:20 run effect give @s levitation 3 0 true 
execute as @e[type=#entities:hostile,distance=..10] if predicate dlc:20 run effect give @s poison 6 0 true 
execute as @e[type=#entities:hostile,distance=..10] if predicate dlc:20 run effect give @s weakness 3 0 true 
execute as @e[type=#entities:hostile,distance=..10] if predicate dlc:20 run effect give @s wither 3 0 true 
