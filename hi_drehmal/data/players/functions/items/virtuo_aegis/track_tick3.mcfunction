...
execute if score #exists temp matches 1.. run teleport @s @e[type=arrow,tag=temp,limit=1]
execute if score #exists temp matches 1.. run tag @e[type=arrow,tag=temp] remove temp
