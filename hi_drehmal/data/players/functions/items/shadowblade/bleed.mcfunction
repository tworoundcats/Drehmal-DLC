execute as @a as @s[scores={bleed=20}] run execute as @e[tag=bleed,limit=1] run damage @s 5 generic by @p
...
execute as @a as @s[scores={bleed=40}] run execute as @e[tag=bleed,limit=1] run damage @s 5 generic by @p
...
execute as @a as @s[scores={bleed=60}] run execute as @e[tag=bleed,limit=1] run damage @s 5 generic by @p
...
execute as @a as @s[scores={bleed=80}] run execute as @e[tag=bleed,limit=1] run damage @s 5 generic by @p
...
execute as @a as @s[scores={bleed=100}] run execute as @e[tag=bleed,limit=1] run damage @s 5 generic by @p
