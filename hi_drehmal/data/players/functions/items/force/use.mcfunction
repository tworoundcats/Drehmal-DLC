...
execute as @e[tag=thun] unless entity @s[scores={blocking3=..4,blocked=1..}] run damage @s 20 minecraft:strangled by @p
execute as @e[tag=thun] if entity @s[scores={blocking3=..4,blocked=1..}] run function players:items/reticent/main
kill @e[tag=thun_dmg]
