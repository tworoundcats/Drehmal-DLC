...
execute at @s as @e[type=!player,type=!#entities:dummy,type=!#entities:highcapacity,type=!#entities:proj,limit=1,distance=..2] run damage @s[scores={blocking3=..4,blocked=1..}] 8 generic by @p[tag=voided]
