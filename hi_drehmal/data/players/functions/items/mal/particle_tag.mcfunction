...
execute store result entity @s Rotation[0] float 0.09 run scoreboard players get #rand temp
execute store result entity @s Rotation[2] float 0.09 run scoreboard players get #rand temp
