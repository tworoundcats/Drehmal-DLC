...
execute if score @s charging matches 30 at @s positioned ^ ^1 ^ if entity @p[predicate=players:holding/male2] run damage @s 10 generic by @p[predicate=players:holding/male2]
...
execute if score @s charging matches 30 at @s positioned ^ ^1 ^ unless entity @p[predicate=players:holding/male2] run damage @s 10 generic
...
execute if score @s charging matches 60 at @s positioned ^ ^1 ^ if entity @p[predicate=players:holding/male2] run damage @s 10 generic by @p[predicate=players:holding/male2]
...
execute if score @s charging matches 60 at @s positioned ^ ^1 ^ unless entity @p[predicate=players:holding/male2] run damage @s 10 generic
...
execute if score @s charging matches 90 at @s positioned ^ ^1 ^ if entity @p[predicate=players:holding/male2] run damage @s 10 generic by @p[predicate=players:holding/male2]
...
execute if score @s charging matches 90 at @s positioned ^ ^1 ^ unless entity @p[predicate=players:holding/male2] run damage @s 10 generic
