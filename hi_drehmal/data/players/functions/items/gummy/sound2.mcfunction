...
playsound minecraft:dcustom.block.bamboo.hit player @s ~ ~ ~ 0.4 0.5
playsound minecraft:dcustom.block.nether_wart.break player @s ~ ~ ~ 0.6 0.7
playsound minecraft:dcustom.block.sweet_berry_bush.break player @s ~ ~ ~ 0.6 0.9
playsound minecraft:dcustom.entity.rabbit.ambient player @s ~ ~ ~ 0.2 1
playsound minecraft:dcustom.block.lily_pad.place player @s ~ ~ ~ 0.3 0.6
playsound minecraft:dcustom.block.lily_pad.break player @s ~ ~ ~ 0.3 0.2
playsound minecraft:dcustom.block.candle.break player @s ~ ~ ~ 0.4 0.2
tellraw @s {"text":"Should've been a bit more careful...","bold":false,"color":"dark_gray","italic": true}
tag @s remove gummy
...
execute at @s run loot spawn ~ ~ ~ loot dlc:gummy