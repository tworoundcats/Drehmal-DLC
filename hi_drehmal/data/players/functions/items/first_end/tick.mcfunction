...
execute if score @s ai_timer matches 1 positioned ~ ~ ~-2 as @e[type=!player,predicate=!entities:invul,type=!#entities:dummy,type=!#entities:tickless_passive,type=!#entities:highcapacity,type=!#entities:proj,distance=..2] run damage @s[scores={blocking3=..4,blocked=1..}] 3 strangled by @p
...
execute if score @s ai_timer matches 2 positioned ~-2 ~ ~ as @e[type=!player,predicate=!entities:invul,type=!#entities:dummy,type=!#entities:tickless_passive,type=!#entities:highcapacity,type=!#entities:proj,distance=..2] run damage @s[scores={blocking3=..4,blocked=1..}] 3 strangled by @p
...
execute if score @s ai_timer matches 3 positioned ~ ~ ~2 as @e[type=!player,predicate=!entities:invul,type=!#entities:dummy,type=!#entities:tickless_passive,type=!#entities:highcapacity,type=!#entities:proj,distance=..2] run damage @s[scores={blocking3=..4,blocked=1..}] 3 strangled by @p
...
execute if score @s ai_timer matches 4 positioned ~2 ~ ~ as @e[type=!player,predicate=!entities:invul,type=!#entities:dummy,type=!#entities:tickless_passive,type=!#entities:highcapacity,type=!#entities:proj,distance=..2] run damage @s[scores={blocking3=..4,blocked=1..}] 3 strangled by @p
...
execute if score @s ai_timer matches 5 positioned ~-1.5 ~ ~-1.5 as @e[type=!player,predicate=!entities:invul,type=!#entities:dummy,type=!#entities:tickless_passive,type=!#entities:highcapacity,type=!#entities:proj,distance=..2] run damage @s[scores={blocking3=..4,blocked=1..}] 3 strangled by @p
...
execute if score @s ai_timer matches 6 positioned ~1.5 ~ ~1.5 as @e[type=!player,predicate=!entities:invul,type=!#entities:dummy,type=!#entities:tickless_passive,type=!#entities:highcapacity,type=!#entities:proj,distance=..2] run damage @s[scores={blocking3=..4,blocked=1..}] 3 strangled by @p
...
execute if score @s ai_timer matches 7 positioned ~ ~1 ~-2 as @e[type=!player,predicate=!entities:invul,type=!#entities:dummy,type=!#entities:tickless_passive,type=!#entities:highcapacity,type=!#entities:proj,distance=..2] run damage @s[scores={blocking3=..4,blocked=1..}] 3 strangled by @p
...
execute if score @s ai_timer matches 8 positioned ~-2 ~1 ~ as @e[type=!player,predicate=!entities:invul,type=!#entities:dummy,type=!#entities:tickless_passive,type=!#entities:highcapacity,type=!#entities:proj,distance=..2] run damage @s[scores={blocking3=..4,blocked=1..}] 3 strangled by @p
...
execute if score @s ai_timer matches 9 positioned ~ ~ ~2.5 as @e[type=!player,predicate=!entities:invul,type=!#entities:dummy,type=!#entities:tickless_passive,type=!#entities:highcapacity,type=!#entities:proj,distance=..2] run damage @s[scores={blocking3=..4,blocked=1..}] 3 strangled by @p
...
execute if score @s ai_timer matches 10 positioned ~2.5 ~ ~ as @e[type=!player,predicate=!entities:invul,type=!#entities:dummy,type=!#entities:tickless_passive,type=!#entities:highcapacity,type=!#entities:proj,distance=..2] run damage @s[scores={blocking3=..4,blocked=1..}] 3 strangled by @p
...
execute if score @s ai_timer matches 11 positioned ~1.5 ~ ~-1.5 as @e[type=!player,predicate=!entities:invul,type=!#entities:dummy,type=!#entities:tickless_passive,type=!#entities:highcapacity,type=!#entities:proj,distance=..2] run damage @s[scores={blocking3=..4,blocked=1..}] 3 strangled by @p
...
execute if score @s ai_timer matches 12 positioned ~-1.5 ~ ~1.5 as @e[type=!player,predicate=!entities:invul,type=!#entities:dummy,type=!#entities:tickless_passive,type=!#entities:highcapacity,type=!#entities:proj,distance=..2] run damage @s[scores={blocking3=..4,blocked=1..}] 3 strangled by @p
...
execute if score @s ai_timer matches 13 positioned ~ ~0.5 ~-2 as @e[type=!player,predicate=!entities:invul,type=!#entities:dummy,type=!#entities:tickless_passive,type=!#entities:highcapacity,type=!#entities:proj,distance=..2] run damage @s[scores={blocking3=..4,blocked=1..}] 3 strangled by @p
...
execute if score @s ai_timer matches 14 positioned ~2 ~0.5 ~2 as @e[type=!player,predicate=!entities:invul,type=!#entities:dummy,type=!#entities:tickless_passive,type=!#entities:highcapacity,type=!#entities:proj,distance=..2] run damage @s[scores={blocking3=..4,blocked=1..}] 3 strangled by @p
...
execute if score @s ai_timer matches 15 positioned ~ ~ ~-3 as @e[type=!player,predicate=!entities:invul,type=!#entities:dummy,type=!#entities:tickless_passive,type=!#entities:highcapacity,type=!#entities:proj,distance=..2] run damage @s[scores={blocking3=..4,blocked=1..}] 3 strangled by @p