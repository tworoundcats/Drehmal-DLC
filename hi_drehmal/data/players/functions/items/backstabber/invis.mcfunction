...
execute as @e[tag=firsthit,tag=!firsthit1,tag=!secondhit] run damage @s[scores={blocking3=..4,blocked=1..}] 20 generic by @p
...
execute as @e[tag=secondhit,tag=!secondhit1] run damage @s[scores={blocking3=..4,blocked=1..}] 40 generic by @p
