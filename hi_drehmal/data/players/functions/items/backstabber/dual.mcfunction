...
execute as @e[tag=firsthit,tag=!1firsthit1] run damage @s 60 generic by @p
...
execute if score #rand temp matches 1 run execute as @e[type=!player,type=!#entities:dummy,type=!#entities:highcapacity,type=!#entities:proj,tag=!1secondhit] at @s if predicate entities:hurt run tag @s add 1secondhit
...
execute as @e[tag=1secondhit,tag=!1secondhit1] run damage @s 80 generic by @p
