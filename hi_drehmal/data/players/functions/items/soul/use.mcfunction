...
execute at @e[type=minecraft:marker,tag=soul_dmg] run execute as @e[sort=nearest,limit=3,type=!player,type=!#entities:dummy,type=!#entities:highcapacity,type=!#entities:proj,distance=..4] run damage @s 5 minecraft:truedamage
kill @e[type=marker,tag=soul_dmg]
damage @s 18 truedamage
