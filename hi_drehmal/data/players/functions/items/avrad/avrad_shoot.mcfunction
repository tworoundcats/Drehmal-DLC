...
summon marker ^ ^-0.5 ^-0.5 {Tags:["special","avgun_red","avrad_bullet","fancy","pierce","accelerate_nl"]}
...
playsound minecraft:dcustom.block.respawn_anchor.deplete hostile @a ~ ~ ~ 0.3 1.5
tag @s add temp_avgun
execute as @e[type=marker,tag=special] run function players:items/avrad/avrad_stats
