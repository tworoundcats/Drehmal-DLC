...
execute as @s if entity @s[tag=comp] at @s run attribute @s minecraft:generic.movement_speed modifier add d485fa50-bfd2-4c02-80fe-58e313f46de1 generic.movement.speed -1 add
