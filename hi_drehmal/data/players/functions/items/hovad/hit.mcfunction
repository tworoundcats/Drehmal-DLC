...
attribute @s minecraft:generic.armor modifier add 4-9-345-31-2 "hvd_armor" -0.30 multiply
attribute @s minecraft:generic.armor_toughness modifier add 4-9-345-31-2 "hvd_armor" -0.30 multiply
attribute @s[tag=!emissary] minecraft:generic.knockback_resistance modifier add 4-9-345-31-2 "hvd_armor" -0.30 multiply
