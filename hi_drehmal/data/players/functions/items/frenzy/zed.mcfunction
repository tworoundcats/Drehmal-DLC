...
execute as @e[type=!player,type=!#entities:dummy,type=!#entities:highcapacity,type=!#entities:proj,distance=..14] if score #rand temp matches 1 as @s run data merge entity @s {Tags:["explode"]}
