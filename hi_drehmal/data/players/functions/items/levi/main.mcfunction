execute as @s run scale set pehkui:entity_reach 3.2 @s
...
execute as @s run execute store result score #levi_true levi_damage run attribute @s minecraft:generic.attack_damage get 1
execute as @s run execute store result score #levi levi_damage run attribute @s minecraft:generic.attack_damage get 0.4

execute as @s run execute store result score #levi_heal temp run attribute @s minecraft:generic.attack_damage get 0.05
