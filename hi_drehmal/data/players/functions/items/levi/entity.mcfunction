...
execute at @s run tp @e[tag=!mythic_pvp,predicate=!players:holding/leviathan,predicate=!entities:invul,type=!#entities:dummy,type=!#entities:tickless_passive,type=!#entities:highcapacity,type=!#entities:proj,distance=..2.5,limit=5,tag=!oblivion_immune,tag=!obv.immune] @s

execute at @s as @e[tag=!mythic_pvp,predicate=!players:holding/leviathan,type=!#entities:dummy,type=!#entities:tickless_passive,type=!#entities:highcapacity,type=!#entities:proj,distance=..2.5] unless entity @s[scores={blocking3=..4,blocked=1..}] run damage @s 4 minecraft:generic by @p
execute at @s as @e[tag=!mythic_pvp,predicate=!players:holding/leviathan,type=!#entities:dummy,type=!#entities:tickless_passive,type=!#entities:highcapacity,type=!#entities:proj,distance=..2.5] if entity @s[scores={blocking3=..4,blocked=1..}] run function players:items/reticent/main
execute at @s as @e[tag=!mythic_pvp,predicate=!players:holding/leviathan,type=!#entities:dummy,type=!#entities:tickless_passive,type=!#entities:highcapacity,type=!#entities:proj,distance=..2.5,limit=1] if predicate entities:hurt2 run scoreboard players add #levi num 1
...
execute if block ^ ^ ^0.2 #core:empty run tp @s ^ ^ ^0.2 facing entity @e[tag=!mythic_pvp,predicate=!players:holding/leviathan,type=!#entities:tickless_passive,type=!#entities:dummy,type=!#entities:highcapacity,type=!#entities:proj,distance=2.5..15,limit=1,sort=nearest]
