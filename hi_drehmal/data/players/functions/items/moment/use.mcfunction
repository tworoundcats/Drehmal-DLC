...
execute as @e[tag=!mythic_pvp,tag=!m_holder,type=!#entities:dummy,type=!#entities:tickless_passive,type=!#entities:highcapacity,type=!#entities:proj,distance=..6] run function players:items/moment/stun
scoreboard players reset @s moment
tag @s remove m_holder