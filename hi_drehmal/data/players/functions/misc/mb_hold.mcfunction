...
execute unless score #DLC mastermode matches 1 run scoreboard players operation #break? temp %= #84 const
execute unless score #DLC mastermode matches 1 run scoreboard players operation #damage temp /= #84 const
execute if score #DLC mastermode matches 1 run scoreboard players operation #break? temp %= #55 const
execute if score #DLC mastermode matches 1 run scoreboard players operation #damage temp /= #55 const
execute unless score #DLC mastermode matches 1 if score #mb_run_active? bool matches 1 unless score @s kdelay matches 1.. if score #break? temp matches 83 unless score #k_dia4 bool matches 1 run function players:misc/mb/damage
execute if score #DLC mastermode matches 1 if score #mb_run_active? bool matches 1 unless score @s kdelay matches 1.. if score #break? temp matches 54 unless score @s mb_run matches 1.. run function players:misc/mb/damage
execute unless score #DLC mastermode matches 1 if score #mb_run_active? bool matches 1 unless score @s kdelay matches 1.. if score @s ktimer matches 8400.. unless score #k_dia4 bool matches 1 positioned ~ ~1 ~ positioned ^ ^ ^1 run function players:misc/mb/explode
execute if score #DLC mastermode matches 1 if score #mb_run_active? bool matches 1 unless score @s kdelay matches 1.. if score @s ktimer matches 5400.. positioned ~ ~1 ~ positioned ^ ^ ^1 run function players:misc/mb/explode
execute if score #DLC mastermode matches 1 if score #mb_run_active? bool matches 1 at @s[predicate=players:locations/mb_boom,tag=!exploded] unless score #k_dia4 bool matches 1 positioned ~ ~1 ~ positioned ^ ^ ^1 run function players:misc/mb/boom
...
execute if score #hold? temp matches 1 if predicate players:mb_valid unless entity @s[predicate=players:lodahr,x=424,y=1,z=-847,dx=60,dy=20,dz=31] unless score #DLC mastermode matches 1 unless entity @s[x=1843,z=-4267,distance=..50] run function players:misc/mb/tick
execute if score #hold? temp matches 1 if predicate players:mb_valid unless entity @s[predicate=players:lodahr,x=424,y=1,z=-847,dx=60,dy=20,dz=31] if score #DLC mastermode matches 1 run function players:misc/mb/tick
...
execute if score #hold? temp matches 1 unless score #DLC mastermode matches 1 unless predicate players:mb_valid run scoreboard players reset @s kanger
...
scoreboard players remove @s mb_run 1