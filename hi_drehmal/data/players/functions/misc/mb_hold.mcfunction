...
execute if score #DLC mastermode matches 1 run scoreboard players operation #break? temp %= #54 const
execute if score #DLC mastermode matches 1 run scoreboard players operation #damage temp /= #54 const
...
execute if score #DLC mastermode matches 1 if score #mb_run_active? bool matches 1 unless score @s kdelay matches 1.. if score #break? temp matches 53 run function players:misc/mb/damage
