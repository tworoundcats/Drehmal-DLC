advancement revoke @s only players:interact/foundry2

execute as @e[type=armor_stand,tag=foundry_vis] run data modify entity @s DisabledSlots set value 62
execute as @e[type=armor_stand,tag=foundry_vis] run data modify entity @s Marker set value 0b
execute as @e[type=armor_stand,tag=foundry_display] run data modify entity @s DisabledSlots set value 63
execute as @e[type=armor_stand,tag=foundry_display] run data modify entity @s Marker set value 1b
