...
execute if score #rand temp matches 0..2 as @e[type=interaction,tag=ace] at @s as @e[type=item_display,distance=..0.5,limit=1,sort=nearest] run data modify entity @s item.id set value "dlc:ace"
execute if score #rand temp matches 3..10 as @e[type=interaction,tag=ace] at @s as @e[type=item_display,distance=..0.5,limit=1,sort=nearest] run data modify entity @s item.id set value "dlc:eight"
...
execute if score #rand temp matches 0..2 run schedule function dlc:zul/game/card_ace 1s
execute if score #rand temp matches 3..10 run schedule function dlc:zul/game/card_diamonds 1s
