...
execute at @s as @e[type=glow_item_frame,tag=star,distance=..6] run damage @s 10
execute at @s as @e[type=glow_item_frame,tag=artifact,distance=..6] run damage @s 10
