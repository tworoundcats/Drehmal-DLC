...
execute if score #generals_music? bool matches 1 positioned 27339.50 152.00 747.50 if entity @s[distance=..40,tag=!finished] run function players:music/generals
