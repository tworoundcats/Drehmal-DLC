...
execute if entity @s[tag=generals_spawnpoint] run function players:spawn/clear_temp_spawn
execute if entity @s[tag=generals_spawnpoint,predicate=players:is_not_dev] run function players:gamemode/set_survival
...
tag @s remove generals_spawnpoint
