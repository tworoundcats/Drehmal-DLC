...
execute if score #avpod.newsong temp matches 2 run tellraw @s {"text":"Added [Déjà Vu]!","color":"green"}
...
execute if score #avpod.newsong temp matches 37 run tellraw @s {"text":"Added [Lodahr #5]!","color":"green"}
execute if score #avpod.newsong temp matches 38 run tellraw @s {"text":"Added [Lodahr #6]!","color":"green"}
...
execute if score #avpod.newsong temp matches 43 run tellraw @s {"text":"Added [Welcome Aboard]!","color":"green"}
execute if score #avpod.newsong temp matches 44 run tellraw @s {"text":"Added [Imponderous]!","color":"green"}
execute if score #avpod.newsong temp matches 45 run tellraw @s {"text":"Added [Core]!","color":"green"}
execute if score #avpod.newsong temp matches 46 run tellraw @s {"text":"Added [Divine Fulmination]!","color":"green"}
execute if score #avpod.newsong temp matches 47 run tellraw @s {"text":"Added [The Mountain of Holes]!","color":"green"}
execute if score #avpod.newsong temp matches 48 run tellraw @s {"text":"Added [Fear and Madness]!","color":"green"}
execute if score #avpod.newsong temp matches 49 run tellraw @s {"text":"Added [Nothing to Lose]!","color":"green"}
execute if score #avpod.newsong temp matches 50 run tellraw @s {"text":"Added [Resonant Halls]!","color":"green"}
execute if score #avpod.newsong temp matches 51 run tellraw @s {"text":"Added [Fate of the Fallen]!","color":"green"}
execute if score #avpod.newsong temp matches 52 run tellraw @s {"text":"Added [Before the Storm]!","color":"green"}
execute if score #avpod.newsong temp matches 53 run tellraw @s {"text":"Added [At The Edge of Oblivion]!","color":"green"}
execute if score #avpod.newsong temp matches 54 run tellraw @s {"text":"Added [Death of a World]!","color":"green"}

tellraw @s [""," -.-",{"text":" [Set Name]","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger avpod.menu_press set 300"},"hoverEvent":{"action":"show_text","contents":[{"text":"Opens the playlist name editor.","color":"gray"},"\n",{"text":"Click to edit!","color":"yellow"}]}},{"text":" [View Songs]","color":"yellow","clickEvent":{"action":"run_command","value":"function players:avpod/playlists/songlistnew"},"hoverEvent":{"action":"show_text","contents":[{"text":"View the songs in the playlist you are making.","color":"gray"},"\n",{"text":"Click to view!","color":"yellow"}]}}," -.-"]
