advancement grant @a only weapons:harbinger
execute unless score #gotHarbinger bool matches 1 as @a run playsound minecraft:particle.soul_escape player @s ~ ~ ~ 20 0
execute unless score #gotHarbinger bool matches 1 as @a run playsound minecraft:ambient.cave player @s ~ ~ ~ 20 2
