...
execute at @e[tag=russell] as @a[distance=..20] run journal quest addon @s Russell [{"text":"Surely, an Avsohmic ruin has to have some record of what they explored! Maybe on the western or eastern coast?"}]
