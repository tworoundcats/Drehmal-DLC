...
execute at @e[tag=russell] as @a[distance=..20] run journal quest addon @s Russell [{"text":"There has to be some piece of writing that tells that whole story. Maybe written in the alchemist's own words?"}]
