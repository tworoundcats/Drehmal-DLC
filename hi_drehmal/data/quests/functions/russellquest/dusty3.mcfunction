...
execute at @e[tag=russell] as @a[distance=..20] run journal quest addon @s Russell [{"text":"I just know there's got to be an incredible piece on his life. Maybe even a primary source?"}]
