execute positioned ~ ~ ~ as @p[tag=qst11] at @s run tellraw @s ["",{"text":"Quest Completed: ","color":"yellow"},{"text":"Bring Russell a Book about the Ancient Necromancer","color":"white"}]
...
execute positioned ~ ~ ~ as @p[tag=qst11] at @s run give @s emerald 16
...
execute positioned 31.48 67.00 5263.55 as @e[name="Russell",type=villager,distance=..5] run tag @s add qend
