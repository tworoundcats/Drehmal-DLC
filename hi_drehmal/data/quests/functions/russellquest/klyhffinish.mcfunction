execute positioned ~ ~ ~ as @p[tag=qst11] at @s run tellraw @s ["",{"text":"Quest Completed: ","color":"yellow"},{"text":"Bring Russell a Book about Mael's Alchemist","color":"white"}]
...
execute positioned ~ ~ ~ as @p[tag=qst11] at @s run give @s emerald 40
