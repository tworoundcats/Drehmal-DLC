...
execute at @e[tag=russell] as @a[distance=..20] run journal quest addon @s Russell [{"text":"It's gotta be real! If you can find it and bring it to me, I'll make it well worth your while."}]
