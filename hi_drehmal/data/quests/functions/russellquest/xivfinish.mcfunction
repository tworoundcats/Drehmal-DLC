execute positioned ~ ~ ~ as @p[tag=qst11] at @s run tellraw @s ["",{"text":"Quest Completed: ","color":"yellow"},{"text":"Bring Russell a Book about the Avsohmic Xivrhynt Expedition","color":"white"}]
