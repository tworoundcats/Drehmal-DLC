execute positioned 31.48 67.00 5263.55 as @e[tag=russell] run tag @s add wantsbook3
tellraw @p[tag=qst11] ["",{"text":"Quest Started: ","color":"yellow"},{"text":"Bring Russell the Fifth Parable","color":"white"}]
