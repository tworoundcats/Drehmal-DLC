...
execute at @e[tag=russell] as @a[distance=..20] run journal quest addon @s Russell [{"text":"He's only ever referred to as the "},{"text":"Lord of Dust","color":"yellow"},{"text":". Ominous title, isn't it?"}]
