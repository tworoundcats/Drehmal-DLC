execute as @e[type=interaction,tag=keeko] run data remove entity @s interaction
execute as @e[type=interaction,tag=casey] run data remove entity @s interaction
execute as @e[type=interaction,tag=chris] run data remove entity @s interaction
execute as @e[type=interaction,tag=cinder] run data remove entity @s interaction
execute as @e[type=interaction,tag=corvid] run data remove entity @s interaction
execute as @e[type=interaction,tag=daniel] run data remove entity @s interaction
execute as @e[type=interaction,tag=dome] run data remove entity @s interaction
execute as @e[type=interaction,tag=dread] run data remove entity @s interaction
execute as @e[type=interaction,tag=gamer] run data remove entity @s interaction
execute as @e[type=interaction,tag=gragas] run data remove entity @s interaction
execute as @e[type=interaction,tag=mahkar] run data remove entity @s interaction
execute as @e[type=interaction,tag=major] run data remove entity @s interaction
execute as @e[type=interaction,tag=mouton] run data remove entity @s interaction
execute as @e[type=interaction,tag=rift] run data remove entity @s interaction
execute as @e[type=interaction,tag=russell] run data remove entity @s interaction
execute as @e[type=interaction,tag=tahlros] run data remove entity @s interaction
execute as @e[type=interaction,tag=weller] run data remove entity @s interaction
