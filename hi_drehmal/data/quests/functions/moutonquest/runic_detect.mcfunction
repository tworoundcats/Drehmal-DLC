...
execute positioned ~ ~ ~ as @e[type=villager,name="Muhton"] run tag @s remove runic
execute positioned ~ ~ ~ as @p[tag=qst6] at @s run tellraw @s ["",{"text":"<"},{"text":"Muhton","color":"dark_purple"},{"text":"> Yeah, that'll work. Let's see..."}]
