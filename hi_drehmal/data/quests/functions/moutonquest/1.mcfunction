...
execute at @e[tag=mouton] run tellraw @a[distance=..12] ["",{"text":"<"},{"text":"Muhton","color":"dark_purple"},{"text":"> That should be enough for those idiot publishers. Thanks for the help. Here, your cut of the profits."}]
