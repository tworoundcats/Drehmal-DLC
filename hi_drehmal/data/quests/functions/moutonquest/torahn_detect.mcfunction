...
execute positioned ~ ~ ~ as @e[tag=mouton] run tag @s remove torahn
execute at @e[tag=mouton] run tellraw @a[distance=..12] ["",{"text":"<"},{"text":"Muhton","color":"dark_purple"},{"text":"> Great, thanks."}]
