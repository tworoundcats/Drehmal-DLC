execute positioned ~ ~ ~ as @p[tag=qst14] at @s run tellraw @s ["",{"text":"Quest Completed: ","color":"yellow"},{"text":"Retrieve Corv Ihd's Painting","color":"white"}]
