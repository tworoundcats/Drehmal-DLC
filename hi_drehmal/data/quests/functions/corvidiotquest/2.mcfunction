execute positioned ~ ~ ~ as @p[tag=qst14] at @s run tellraw @s ["",{"text":"<"},{"text":"Corv Ihd","color":"black"},{"text":"> Here. It's not much, but it's what I can spare right now. Thanks to you, I think I'll have the motivation to get back on my feet!"}]
