...
execute positioned ~ ~ ~ as @p[tag=qst5] at @s run summon experience_orb ~ ~ ~2 {Value:3}
execute positioned ~ ~ ~ as @p[tag=qst5] at @s run summon experience_orb ~ ~ ~1 {Value:3}
execute positioned ~ ~ ~ as @p[tag=qst5] at @s run summon experience_orb ~ ~ ~2 {Value:3}
execute positioned ~ ~ ~ as @p[tag=qst5] at @s run summon experience_orb ~ ~ ~1 {Value:3}
execute positioned ~ ~ ~ as @p[tag=qst5] at @s run summon experience_orb ~ ~ ~2 {Value:3}
execute positioned ~ ~ ~ as @p[tag=qst5] at @s run summon experience_orb ~ ~ ~1 {Value:3}
...
execute positioned ~ ~ ~ as @p[tag=qst5] run advancement grant @a only dlc:gragas

execute at @e[tag=gragas] as @a[distance=..20] run journal quest complete @s Gragas
execute at @e[tag=gragas] as @a[distance=..20] at @s run playsound dlc:writing player @s ~ ~ ~ 1 1

execute positioned ~ ~ ~ as @p[tag=qst5] at @s run function dlc:give/olkahan
execute positioned ~ ~ ~ as @p[tag=qst5] at @s run function dlc:give/silver
execute positioned ~ ~ ~ as @p[tag=qst5] at @s run function dlc:give/silver

execute as @e[tag=gragas] run tag @s add qend
