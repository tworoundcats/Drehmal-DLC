...
execute positioned ~ ~ ~ as @p[tag=qst13] at @s run give @s simplyswords:empowered_remnant{PrismaticAmalgam:1b,display: {Name: '{"extra":[{"italic":false,"color":"dark_red","text":"Prismatic Amalgam"}],"text":""}', Lore: ['{"extra":[{"italic":false,"color":"dark_purple","text":"A bizarre blend of different flavors"}],"text":""}', '{"extra":[{"italic":false,"color":"dark_purple","text":"of Primal Energy, each influenced by "}],"text":""}', '{"extra":[{"italic":false,"color":"dark_purple","text":"one of the realm\'s powerful gods."}],"text":""}', '{"extra":[{"italic":false,"color":"dark_purple","text":"It feels simultaneously alien and"}],"text":""}', '{"extra":[{"italic":false,"color":"dark_purple","text":"intimately familiar, an unspoken remnant"}],"text":""}', '{"extra":[{"italic":false,"color":"dark_purple","text":"of what once was and what could one "}],"text":""}', '{"extra":[{"italic":false,"color":"dark_purple","text":"day be again. "}],"text":""}', '{"extra":[{"italic":false,"color":"dark_purple","text":" "}],"text":""}', '{"extra":[{"italic":false,"color":"dark_purple","text":"Such power should not go unutilized."}],"text":""}', '{"extra":[{"italic":false,"color":"dark_purple","text":" "}],"text":""}', '{"extra":[{"italic":false,"obfuscated":true,"color":"dark_red","text":"Unspoken"}],"text":""}']}, HideFlags: 32}
execute as @p[tag=qst13] run give @s mythicmetals:silver_ingot{display: {Name: '{"extra":[{"italic":false,"color":"aqua","text":"Silver Ingot"}],"text":""}', Lore: ['{"extra":[{"italic":true,"color":"dark_purple","text":"The merchants of Drehmal like a"}],"text":""}', '{"extra":[{"italic":true,"color":"dark_purple","text":"sack of scales as much as any"}],"text":""}', '{"extra":[{"italic":true,"color":"dark_purple","text":"other, but for special equipment,"}],"text":""}', '{"extra":[{"italic":true,"color":"dark_purple","text":"silver is the currency of choice."}],"text":""}', '{"text":""}']}} 8
