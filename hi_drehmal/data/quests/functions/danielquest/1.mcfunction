execute at @e[tag=daniel] run tellraw @a[distance=..20] {"text":"1/5 Orbs Submitted!","color":"yellow"}
...
execute as @e[type=villager,name="Daniel"] run item replace entity @s weapon.mainhand with air
