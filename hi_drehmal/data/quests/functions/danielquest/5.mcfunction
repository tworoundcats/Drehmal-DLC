execute positioned ~ ~ ~ as @p[tag=qst13] at @s run tellraw @s {"text":"5/5 Orbs Submitted!","color":"yellow"}
...
execute as @e[type=villager,name="Daniel",tag=orbcollecting] run tag @s remove orbcollecting
