...
execute unless entity @a[tag=qst4] run execute at @e[tag=casey] run tellraw @a[distance=..20] ["",{"text":"<","color":"white"},{"text":"Casey","color":"dark_green"},{"text":"> ","color":"white"},{"text":"You ever crashed part of the economy before? It's a REAL rush. And you can help me do it!"}]
