execute at @e[tag=casey] run tellraw @a[distance=..20] ["",{"text":"<"},{"text":"Casey","color":"dark_green"},{"text":"> Here, why don't you take a little bit of it? You can have my old axe, too. Johmund's is nicer."}]
