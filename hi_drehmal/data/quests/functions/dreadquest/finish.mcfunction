...
execute positioned ~ ~ ~ as @p[tag=qst7] at @s run tellraw @s ["",{"text":"Quest Finished: ","color":"yellow"},{"text":"Steal the Tide Queen's Blade","color":"white"}]
