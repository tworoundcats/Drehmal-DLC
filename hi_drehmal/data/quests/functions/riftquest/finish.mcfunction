...
execute at @e[tag=rift] as @a[distance=..20] run journal quest complete @s Rift
...
execute as @e[tag=rift] run tag @s add qend
execute as @e[tag=rift] run tag @s remove tempd
execute as @e[tag=rift_i] run tag @s add qend
