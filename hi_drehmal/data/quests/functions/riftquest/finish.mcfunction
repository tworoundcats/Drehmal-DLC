...
execute positioned ~ ~ ~ as @p[tag=qst12] at @s run summon experience_orb ~ ~ ~2 {Value:7}
execute positioned ~ ~ ~ as @p[tag=qst12] at @s run summon experience_orb ~ ~ ~1 {Value:7}
execute positioned ~ ~ ~ as @p[tag=qst12] at @s run summon experience_orb ~ ~ ~2 {Value:7}
execute positioned ~ ~ ~ as @p[tag=qst12] at @s run summon experience_orb ~ ~ ~1 {Value:7}
execute positioned ~ ~ ~ as @p[tag=qst12] at @s run summon experience_orb ~ ~ ~2 {Value:7}
execute positioned ~ ~ ~ as @p[tag=qst12] at @s run summon experience_orb ~ ~ ~1 {Value:7}
...
execute positioned ~ ~ ~ as @p[tag=qst12] at @s run give @s mythicmetals:star_platinum{display:{Name:'[{"text":"Stellarium Ingot","italic":false,"color":"aqua"}]',Lore:['[{"text":"It radiates a glowing aura with","italic":false}]','[{"text":"seemingly limitless energy","italic":false}]']}} 2
...
execute as @e[name="Rift Technician",type=villager] run tag @s add qend
