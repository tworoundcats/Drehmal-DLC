...
execute as @p[tag=qst17] at @s run tellraw @a[distance=..50] ["",{"text":"<"},{"text":"Wehl'r","color":"white"},{"text":"> There's "},{"text":"one","color":"yellow"},{"text":". I'll hold onto it until you find the rest."}]
