...
execute at @e[tag=weller] run tellraw @a[distance=..50] ["",{"text":"<"},{"text":"Wehl'r","color":"white"},{"text":"> The fragment of Hate. Probably should've just gotten that one myself..."}]
