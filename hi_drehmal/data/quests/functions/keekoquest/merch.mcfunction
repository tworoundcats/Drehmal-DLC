...
tellraw @s ["",{"text":"<"},{"text":"Keehko","color":"gold"},{"text":"> There aren't supposed to be any more merch vouchers in circulation, but I guess I have to honor it. Do you want to turn that in to me?\n"},{"text":"[Yes]","color":"dark_green","clickEvent":{"action":"run_command","value":"/dlccall function quests:keekoquest/merch_accept"}},{"text":"\n"},{"text":"[No]","color":"dark_red","clickEvent":{"action":"run_command","value":"/dlccall function quests:keekoquest/merch_deny"}}]
