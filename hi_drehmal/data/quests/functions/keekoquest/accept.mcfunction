...
execute unless entity @a[tag=qst] run execute at @e[tag=keeko] run tellraw @a[distance=..12] ["",{"text":"<","color":"white"},{"text":"Keehko","color":"gold"},{"text":"> ","color":"white"},{"text":"One of our horses escaped from the stables, and I can't find him. Would you be able to go track him down and bring him back here for me?"}]
