execute at @e[tag=keeko] run tellraw @a[distance=..12] ["",{"text":"<"},{"text":"MK2182","obfuscated":true,"color":"#FF570F"},{"text":"> Enough. There will be no more Priscilla-based extortion."}]
