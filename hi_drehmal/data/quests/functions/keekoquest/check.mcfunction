...
execute as @s[tag=!haskeekomerch] if predicate players:holding/quest/merch as @e[tag=keeko,tag=qend,tag=!temp_interact] run tag @e[tag=keeko_i] add enabled
execute as @s[tag=!haskeekomerch] if predicate players:holding/quest/merch as @e[tag=keeko,tag=qend,tag=!temp_interact] run tag @e[tag=keeko] remove disabled
