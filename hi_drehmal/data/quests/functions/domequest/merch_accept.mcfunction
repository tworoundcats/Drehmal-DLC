...
execute in minecraft:overworld positioned -1725.48 161.00 1897.49 as @p[tag=domemerchtarget] run tellraw @s ["",{"text":"<"},{"text":"Dohm","color":"blue"},{"text":"> I don't have much here in Drehmal, but I've always got the power to award these!"}]
