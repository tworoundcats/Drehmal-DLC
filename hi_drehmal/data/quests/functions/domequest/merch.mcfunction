...
tellraw @s ["",{"text":"<"},{"text":"Dohm","color":"blue"},{"text":"> Yowzers! What's this? A merch voucher? Do you want to turn that in to me?\n"},{"text":"[Yes]","color":"dark_green","clickEvent":{"action":"run_command","value":"/dlccall function quests:domequest/merch_accept"}},{"text":"\n"},{"text":"[No]","color":"dark_red","clickEvent":{"action":"run_command","value":"/dlccall function quests:domequest/merch_deny"}}]
