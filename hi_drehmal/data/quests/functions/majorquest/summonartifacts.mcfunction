...
execute positioned 881.56 20.00 505.52 unless entity @e[type=glow_item_frame,distance=..2] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[artifact],Fixed:1b,Invisible:1b,Item:{id:"prismarine_shard",Count:1,tag:{mquest:1b,display:{Name:'["",{"text":"Crystalline Shard","italic":false,"underlined":true,"color":"aqua"}]',Lore:['["",{"text":"Quest Item","italic":false,"color":"dark_green"}]']}}}}
