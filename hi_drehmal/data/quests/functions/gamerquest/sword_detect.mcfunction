...
execute at @e[tag=gamer] run tellraw @a[distance=..20] ["",{"text":"<"},{"text":"Ga'Mahr","color":"dark_purple"},{"text":"> I knew I could count on you! My gratitude, adventurer."}]
execute at @e[tag=gamer] as @a[distance=..20] run journal quest addon @s Ga-Mahr [{"text":"I knew I could count on you! My gratitude, adventurer."}]
