execute positioned ~ ~ ~ as @p[tag=qst10] at @s run tellraw @s ["",{"text":"Quest Updated:","color":"yellow"},{"text":" A Saponified Severer!\n"},{"text":"Reawaken the Ancient Blade","italic":true,"color":"gray"}]
...
execute as @e[type=villager,name="Ga'Mahr, Lord of Duht"] run tag @s add acceptingwax