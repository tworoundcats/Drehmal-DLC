...
execute at @e[tag=gamer] as @a[distance=..20] run journal quest addon @s Ga-Mahr [{"text":"Adventurer, you've proven reliable already. Would you please search for more of that odd substance so I might rouse my sword from its slumber?"}]
