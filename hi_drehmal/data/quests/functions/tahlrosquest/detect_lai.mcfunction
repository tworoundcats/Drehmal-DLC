execute as @e[name="Tahlros",type=villager] run item replace entity @s weapon.mainhand from entity @p[tag=qst15,limit=1] weapon.mainhand 
...
function quests:tahlrosquest/lai1