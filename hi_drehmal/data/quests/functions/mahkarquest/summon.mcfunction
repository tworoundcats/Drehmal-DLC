...
summon piglin_brute -2975 91 5190 {IsImmuneToZombification:1b}
summon piglin_brute -2970 91 5193 {IsImmuneToZombification:1b}
summon blaze -2968 91 5196
summon piglin -2962 90 5190

# Ethgar's Champion - Airship
summon piglin_brute -2891 133 5207 {DeathLootTable:"entities:mob/mahkar_target",IsImmuneToZombification:1b,CustomName:'[{"text":"Brash Champion"}]',CustomNameVisible:1b,Health:100,OnGround:1b,PersistenceRequired:1b,Tags:["mahkar_target2"],HandItems:[{id:diamond_sword,tag:{Enchantments:[{lvl:2,id:sharpness}],Unbreakable:1b},Count:1},{}],HandDropChances:[0f,0f],ArmorItems:[{},{},{id:netherite_chestplate,tag:{Enchantments:[{lvl:4,id:projectile_protection}],Unbreakable:1b},Count:1},{}],ArmorDropChances:[0f,0f,0f,0f],Attributes:[{Name:"generic.max_health",Base:100f}]}
