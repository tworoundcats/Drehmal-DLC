...
execute at @e[tag=mahkar] as @a[distance=..20] run journal quest complete @s Mahkar
...
execute positioned ~ ~ ~ as @p[tag=qst16] at @s run function dlc:give/olkahan
execute positioned ~ ~ ~ as @p[tag=qst16] at @s run function dlc:give/olkahan

execute as @e[tag=mahkar] run tag @s add qend
execute as @e[tag=mahkar] run tag @s remove qstart
