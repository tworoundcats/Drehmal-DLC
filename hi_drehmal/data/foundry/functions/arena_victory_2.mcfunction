...
execute as @e[tag=foundry_display,tag=powered,type=armor_stand] if predicate players:holding/primal_focus run tellraw @a ["","[",{"text":"ꜰᴏᴜɴᴅʀy ᴀɪ","color":"red","bold":"true"},"] ᴄʀyꜱᴛᴀʟ ʀᴇꜰɪɴᴇᴍᴇɴᴛ ᴄᴏᴍᴩʟᴇᴛᴇ. ᴡᴇʟʟ ᴅᴏɴᴇ, ꜱᴏʟᴅɪᴇʀ"]
...
setblock -3308 113 1656 minecraft:polished_blackstone_button[face=wall,facing=north,powered=false]