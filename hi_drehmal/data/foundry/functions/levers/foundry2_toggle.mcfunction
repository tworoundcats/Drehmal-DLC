...
execute if score #valhalla bool matches 1 run tellraw @a[x=-3308,y=111,z=1656,distance=..10] ["","[",{"text":"ꜰᴏᴜɴᴅʀy ᴀɪ","color":"red","bold":"true"},"] ɪɴғɪɴɪᴛᴇ ᴍᴏᴅᴇ ᴅɪsᴀʙʟᴇᴅ"]
execute if score #valhalla bool matches 1 run scoreboard players reset #valhalla bool
execute unless score fdry_charged bool matches 1 run tellraw @a[x=-3308,y=111,z=1656,distance=..10] ["","[",{"text":"ꜰᴏᴜɴᴅʀʏ ᴀɪ","color":"red","bold":"true"},"] ᴇɴʜᴀɴᴄᴇᴅ ᴍᴏᴅᴇ ᴅɪsᴀʙʟᴇᴅ"]
