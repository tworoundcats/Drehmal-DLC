...
execute if score wave_time foundry matches 0..200 if score contaminated_mob_count foundry matches 1..6 as @e[type=area_effect_cloud,tag=foundry_fodder,sort=random,limit=1] at @s unless entity @a[distance=..4] run function foundry:mobs/spawn_contaminated
execute if score wave_time foundry matches 0..200 if score agility_mob_count foundry matches 1..8 as @e[type=area_effect_cloud,tag=foundry_fodder,sort=random,limit=1] at @s unless entity @a[distance=..4] run function foundry:mobs/spawn_agility

execute if score wave_time foundry matches 0..200 if score sentry_mob_count foundry matches 1..6 as @e[type=area_effect_cloud,tag=foundry_ranged,sort=random,limit=1] at @s unless entity @a[distance=..4] run function foundry:mobs/spawn_sentry
execute if score wave_time foundry matches 0..200 if score buffer_mob_count foundry matches 1..4 as @e[type=area_effect_cloud,tag=foundry_ranged,sort=random,limit=1] at @s unless entity @a[distance=..4] run function foundry:mobs/spawn_buffer
...
execute if score wave_time foundry matches 0..200 if score chemistry_mob_count foundry matches 1..4 as @e[type=area_effect_cloud,tag=foundry_ranged,sort=random,limit=1] at @s unless entity @a[distance=..4] run function foundry:mobs/spawn_chemistry
...
execute if score wave_time foundry matches 0..200 if score rage_mob_count foundry matches 1..4 as @e[type=area_effect_cloud,tag=foundry_elite,sort=random,limit=1] at @s unless entity @a[distance=..4] run function foundry:mobs/spawn_rage
...
execute if score wave_time foundry matches 200..220 if score contaminated_mob_count foundry matches 1..6 as @e[type=area_effect_cloud,tag=foundry_fodder,sort=random,limit=1] at @s run function foundry:mobs/spawn_contaminated
...
execute if score wave_time foundry matches 200..220 if score buffer_mob_count foundry matches 1..4 as @e[type=area_effect_cloud,tag=foundry_ranged,sort=random,limit=1] at @s run function foundry:mobs/spawn_buffer
...
execute if score wave_time foundry matches 200..220 if score chemistry_mob_count foundry matches 1..4 as @e[type=area_effect_cloud,tag=foundry_ranged,sort=random,limit=1] at @s run function foundry:mobs/spawn_chemistry
...
execute if score wave_time foundry matches 200..220 if score rage_mob_count foundry matches 1..4 as @e[type=area_effect_cloud,tag=foundry_elite,sort=random,limit=1] at @s run function foundry:mobs/spawn_rage
