...
execute if score @s tgrptch.mahkar_accept matches 1 unless entity @s[tag=qst16] run function triggerpatch:quests/mahkar_accept
...
execute if score @s tgrptch.weller_accept matches 1 unless entity @s[tag=qst17] run function triggerpatch:quests/weller_accept
