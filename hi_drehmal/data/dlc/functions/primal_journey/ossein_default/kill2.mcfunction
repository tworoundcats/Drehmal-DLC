schedule function dlc:primal_journey/ossein_default/kill3 1s
...
execute if score #ossein_default timer matches 2000000000.. run data merge entity @e[type=text_display,tag=ossein_default_text,limit=1] {text:'[{"text":"Times Killed: ","color":"gray"},{"score":{"name":"#ossein_default","objective":"Deaths"},"color":"aqua","bold":true},{"text":"\\nTimes Died To: ","color":"gray"},{"score":{"name":"#ossein_default","objective":"ossein_default"},"color":"yellow","bold":true},{"text":"\\nBest Time: ","color":"gray"},{"text":"N/A","color":"gold","bold":true}]'}
execute if score #ossein_default timer matches 2000000000.. run return 1
