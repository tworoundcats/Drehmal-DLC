...
execute positioned 26502.48 205.00 898.52 as @a[distance=..24] run tag @s add no_armor_damage
execute positioned 26502.48 205.00 898.52 as @a[distance=..24] run function players:music/reset
