execute if score #court tempdeaths matches 1 positioned 26497 205 916 run forceload add ~ ~
scoreboard players operation #court timer = #tempdeaths timer
...
execute if score #court stop matches 1 positioned 26497 205 916 run schedule function dlc:primal_journey/foreceload_remove 1s
