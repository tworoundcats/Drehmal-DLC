schedule function dlc:primal_journey/generals/kill3 1s
...
execute if score #generals timer matches 2000000000.. run data merge entity @e[type=text_display,tag=generals_text,limit=1] {text:'[{"text":"Times Killed: ","color":"gray"},{"score":{"name":"#generals","objective":"Deaths"},"color":"aqua","bold":true},{"text":"\\nTimes Died To: ","color":"gray"},{"score":{"name":"#generals","objective":"generals"},"color":"yellow","bold":true},{"text":"\\nBest Time: ","color":"gray"},{"text":"N/A","color":"gold","bold":true}]'}
execute if score #generals timer matches 2000000000.. run return 1
