...
execute unless score #DLC mastermode matches 1 if predicate dlc:1 unless data entity @s Tags unless data entity @s CustomName as @s run function dlc:mobs/convert_elite
execute unless score #DLC mastermode matches 1 if predicate dlc:1 as @s[tag=primal] run function dlc:mobs/convert_elite

execute if score #DLC mastermode matches 1 if predicate dlc:1_5 unless data entity @s Tags unless data entity @s CustomName as @s run function dlc:mobs/convert_elite
