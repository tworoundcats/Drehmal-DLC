...
execute at @a[tag=shielded] run playsound minecraft:block.anvil.land master @a ~ ~ ~ 1.0 2
execute at @a[tag=shielded] run playsound minecraft:block.amethyst_block.break master @a ~ ~ ~ 1.0 2
execute at @a[tag=shielded] run playsound minecraft:entity.generic.explode master @a ~ ~ ~ 1.0 2
