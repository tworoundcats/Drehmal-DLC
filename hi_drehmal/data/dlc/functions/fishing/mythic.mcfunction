...
execute unless score #sf_upgrade_chance bool matches 1 run loot spawn ~ ~ ~ loot gameplay/mythic_generic
execute if score #sf_upgrade_chance bool matches 1 run loot spawn ~ ~ ~ loot minecraft:gameplay/unspoken_generic
execute if score #sf_upgrade_chance bool matches 1 run scoreboard players remove @p[tag=temp_catch] mythic 1
execute if score #sf_upgrade_chance bool matches 1 run scoreboard players add @p[tag=temp_catch] unspoken 1
