...
execute unless score #sf_upgrade_chance bool matches 1 run loot spawn ~ ~ ~ loot gameplay/rare_generic
execute if score #sf_upgrade_chance bool matches 1 run loot spawn ~ ~ ~ loot gameplay/legendary_generic
execute if score #sf_upgrade_chance bool matches 1 run scoreboard players remove @p[tag=temp_catch] rare 1
execute if score #sf_upgrade_chance bool matches 1 run scoreboard players add @p[tag=temp_catch] legendary 1
