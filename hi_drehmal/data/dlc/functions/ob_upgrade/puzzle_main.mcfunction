...
execute positioned 1643 15 -4209 as @e[type=block_display,distance=..0.6,limit=1,sort=nearest] as @s run setblock ~ ~ ~ minecraft:sculk
...
execute positioned 1642 16 -4209 as @e[type=block_display,distance=..0.6,limit=1,sort=nearest] as @s run setblock ~ ~ ~ minecraft:sculk
...
execute positioned 1643 17 -4209 as @e[type=block_display,distance=..0.6,limit=1,sort=nearest] as @s run setblock ~ ~ ~ minecraft:sculk
...
execute unless score #ob_finish bool matches 1 if block 1643 17 -4209 minecraft:sculk if block 1643 15 -4209 minecraft:sculk if block 1642 16 -4209 minecraft:sculk run function dlc:ob_upgrade/puzzle_complete
