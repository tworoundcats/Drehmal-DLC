...
execute positioned 1643 15 -4210 run playsound simplyswords:magic_bow_shoot_impact_03 player @a ~ ~ ~ 2 1
execute positioned 1643 15 -4210 run playsound simplyswords:dark_sword_spell player @a ~ ~ ~ 2 2
