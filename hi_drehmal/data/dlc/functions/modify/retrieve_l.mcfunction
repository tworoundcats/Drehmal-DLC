...
execute as @e[type=armor_stand,tag=interact] run data modify entity @s ArmorItems[1] set value {id:"minecraft:air",Count:1b}
...
execute as @p[tag=selector_l] run tag @s remove selector_l
