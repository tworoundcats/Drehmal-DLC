...
execute as @e[type=armor_stand,tag=interact] run data modify entity @s ArmorItems[0] set value {id:"minecraft:air",Count:1b}
...
execute as @p[tag=selector_b] run tag @s remove selector_b
