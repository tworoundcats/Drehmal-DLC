...
execute as @e[tag=visual] at @s run particle minecraft:firework ~ ~1 ~ 0.5 0.5 0.5 0.1 40 force @a
execute as @e[tag=visual] at @s run particle minecraft:soul_fire_flame ~ ~1 ~ 0.5 1 0.5 0 30 force @a
execute as @e[tag=visual] at @s run particle minecraft:flash ~ ~1 ~ 0.3 0.5 0.3 0 5 normal @a
execute as @e[tag=visual] at @s run particle minecraft:enchanted_hit ~ ~1 ~ 0.5 0.5 0.5 0.1 50 force @a
execute as @e[tag=valid] run schedule function dlc:modify/charge/5 1s
execute as @e[tag=invalid] run schedule function dlc:modify/charge/fail 1s