...
setblock -2859 41 5331 minecraft:lectern[facing=west,has_book=true,powered=false]{Book:{Count:1b,id:"minecraft:writable_book",tag:{RepairCost:0,display:{Name:'{"text":"Symbol of the Burnt"}'},pages:["The Sepulchral Altar is the second holiest site in all of His great empire, only behind His glorious Palace. While best known for being the site of conversion for nearly all Maelmari, it is also a sacred meeting place for Mael's chosen—the Burnt Generals.","It is said that each General bears a special calling card, an insignia granted to them by our Lord himself. In the event of an emergency, one General can summon the others to this very room, simply by tossing their insignia into the great central brazier. ","Our history only recalls one time that such measures have been taken—the Insohmic assault on the Carmine. Shortly thereafter, the invading forces were handily repelled by the combined might of the Empire, including a unified counterattack led by First General Rhalon."]}},Page:2}
