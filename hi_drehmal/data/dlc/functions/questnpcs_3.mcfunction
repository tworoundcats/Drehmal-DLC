...
execute positioned -2719.50 64.00 -1641.50 run forceload remove ~ ~
...
execute positioned 4138.50 65.00 1755.5 run forceload remove ~ ~
...
execute positioned -1570 65 -522 run forceload remove ~ ~

execute positioned 2021 116 -787 run forceload remove ~ ~
