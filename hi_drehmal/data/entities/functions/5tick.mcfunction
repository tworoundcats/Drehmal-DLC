...
execute if score @s ai_timer matches ..3 run execute as @e[tag=passive_head] at @s run execute as @a[distance=..3] run damage @s[scores={blocking3=..4,blocked=1..}] 20 minecraft:bernice/squirm by @e[tag=passive_head,limit=1]
