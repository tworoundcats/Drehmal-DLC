data modify entity @s damage set from storage num:entities tempEntity.damage
data modify entity @s crit set from storage num:entities tempEntity.crit
data modify entity @s PierceLevel set from storage num:entities tempEntity.PierceLevel
data modify entity @s Color set from storage num:entities tempEntity.Color
data modify entity @s CustomPotionEffects set from storage num:entities tempEntity.CustomPotionEffects

scoreboard players set #arrow_speed_scale num 1600
...
execute as @e[type=marker,tag=motion_calc_helper,limit=1,sort=nearest] at @s run tp @s ~ ~3 ~
