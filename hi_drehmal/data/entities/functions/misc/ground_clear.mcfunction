...
execute unless score #DLC mastermode matches 1 if entity @s[tag=ethgar_arrow2] at @s run execute as @a[distance=..2] if entity @s[scores={blocking3=..4,blocked=1..}] run function players:items/reticent/main
...
execute if score #DLC mastermode matches 1 if entity @s[tag=ethgar_arrow2] at @s run execute as @a[distance=..2] if entity @s[scores={blocking3=..4,blocked=1..}] run function players:items/reticent/main
