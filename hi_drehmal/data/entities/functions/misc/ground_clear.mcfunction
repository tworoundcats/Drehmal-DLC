...
execute unless score #DLC mastermode matches 1 if entity @s[tag=ethgar_arrow2] at @s run execute as @a[distance=..2] run damage @s[scores={blocking3=..4,blocked=1..}] 40 in_fire by @e[tag=ethgar,limit=1]
execute if score #DLC mastermode matches 1 if entity @s[tag=ethgar_arrow2] at @s run execute as @a[distance=..2] run damage @s[scores={blocking3=..4,blocked=1..}] 65 in_fire by @e[tag=ethgar,limit=1]
