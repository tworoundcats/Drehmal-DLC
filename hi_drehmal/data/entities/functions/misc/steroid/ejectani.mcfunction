execute if score @s buff_ani matches 72 run playsound minecraft:dcustom.block.fire.extinguish block @a
...
execute if score @s buff_ani matches 72 run playsound minecraft:dcustom.block.bubble_column.whirlpool_inside block @a
...
execute if score @s buff_ani matches ..40 positioned ~ ~1 ~-1 run particle cloud ~ ~ ~ 0 0 0 0.2 1
execute if score @s buff_ani matches 40 run playsound minecraft:dcustom.block.fire.extinguish block @a ~ ~ ~
execute if score @s buff_ani matches 35 run playsound minecraft:dcustom.block.fire.extinguish block @a ~ ~ ~
execute if score @s buff_ani matches 30 run playsound minecraft:dcustom.block.fire.extinguish block @a ~ ~ ~
execute if score @s buff_ani matches 25 run playsound minecraft:dcustom.block.fire.extinguish block @a ~ ~ ~
execute if score @s buff_ani matches 20 run playsound minecraft:dcustom.block.fire.extinguish block @a ~ ~ ~
execute if score @s buff_ani matches 15 run playsound minecraft:dcustom.block.fire.extinguish block @a ~ ~ ~
execute if score @s buff_ani matches 10 run playsound minecraft:dcustom.block.fire.extinguish block @a ~ ~ ~
execute if score @s buff_ani matches 5 run playsound minecraft:dcustom.block.fire.extinguish block @a ~ ~ ~
