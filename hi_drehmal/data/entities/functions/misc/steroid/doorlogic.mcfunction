...
execute if score @s fdoor_old matches 1 if score @s fdoor matches 0 run playsound minecraft:dcustom.block.piston.extend block @a
execute if score @s fdoor_old matches 1 if score @s fdoor matches 0 run fill ~ ~ ~1 ~ ~1 ~1 light_blue_stained_glass_pane
execute if score @s fdoor_old matches 0 if score @s fdoor matches 1 run playsound minecraft:dcustom.block.piston.contract block @a
execute if score @s fdoor_old matches 0 if score @s fdoor matches 1 run fill ~ ~ ~1 ~ ~1 ~1 air

execute if score @s rdoor_old matches 1 if score @s rdoor matches 0 run playsound minecraft:dcustom.block.piston.extend block @a
execute if score @s rdoor_old matches 1 if score @s rdoor matches 0 run fill ~ ~ ~-1 ~ ~1 ~-1 light_blue_stained_glass_pane
execute if score @s rdoor_old matches 0 if score @s rdoor matches 1 run playsound minecraft:dcustom.block.piston.contract block @a
