...
execute as @a[distance=..4] unless entity @s[scores={blocking3=..4,blocked=1..}] run damage @s 3 explosion
execute as @a[distance=..4] if entity @s[scores={blocking3=..4,blocked=1..}] run function players:items/reticent/main
