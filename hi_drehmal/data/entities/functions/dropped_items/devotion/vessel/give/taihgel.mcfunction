...
execute if entity @s[tag=taihgel.9] run tellraw @s {"text":"Resolute Orb","color":"gold","clickEvent":{"action":"run_command","value":"/dlccall function dlc:give/orb/taihgel"}}
tellraw @s {"text":" ","italic":true,"color":"gray"}
