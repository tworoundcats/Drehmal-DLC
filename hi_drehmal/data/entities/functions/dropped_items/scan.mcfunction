...
execute if predicate players:is_vertebrae run tag @s add vertebrae

execute if predicate players:locations/corvid_painting if predicate players:is_painting run function quests:corvidiotquest/painting
tag @s add scanned
