execute if entity @s[tag=rhalon] run function entities:ai/rhalon/main
execute if entity @s[tag=tevus] run function entities:ai/tevus/main
execute if entity @s[tag=burnt_soldier] positioned as @s rotated as @s run function entities:ai/burnt_soldier/main
