...
execute unless score #DLC mastermode matches 1 if entity @s[tag=ethgar_arrow2] at @s run execute as @a[distance=..2.5] run damage @s[scores={blocking3=..4,blocked=1..}] 30 in_fire by @e[tag=ethgar,limit=1]
execute if score #DLC mastermode matches 1 if entity @s[tag=ethgar_arrow2] at @s run execute as @a[distance=..2.5] run damage @s[scores={blocking3=..4,blocked=1..}] 50 in_fire by @e[tag=ethgar,limit=1]
