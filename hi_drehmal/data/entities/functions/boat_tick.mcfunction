...
execute if entity @s[tag=!syzygy_box,predicate=players:true_end] run function entities:misc/break_boat
execute if entity @s[tag=!syzygy_box,predicate=players:locations/red_dawn_devzone] run function entities:misc/break_boat
