...
execute if entity @s[predicate=players:true_end] run function entities:misc/break_boat
execute if entity @s[predicate=players:locations/red_dawn_devzone] run function entities:misc/break_boat
execute if entity @s[predicate=players:locations/ossein_arena] run function entities:misc/break_boat
execute if entity @s[predicate=players:in_em_arena] run function entities:misc/break_boat
execute if entity @s[predicate=players:in_generals_arena] run function entities:misc/break_boat
