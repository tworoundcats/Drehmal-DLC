...
execute positioned ~ ~-2 ~ as @a[distance=..1.5] unless entity @s[scores={blocking3=..4,blocked=1..}] run damage @s 3 minecraft:erupted
execute positioned ~ ~-2 ~ as @a[distance=..1.5] if entity @s[scores={blocking3=..4,blocked=1..}] run function players:items/reticent/main
