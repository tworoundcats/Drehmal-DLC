...
item replace entity @s weapon.mainhand with mcdw:sword_broken_sawblade{AttributeModifiers:[{Amount:1.0d,AttributeName:"minecraft:generic.attack_damage",Operation:0,Slot:"mainhand",UUID:[I;-43852763,1861435685,-1714780084,1341114750]}],CustomModelData:12,Damage:0} 1
item replace entity @s weapon.offhand with mcdw:sword_broken_sawblade{AttributeModifiers:[{Amount:1.0d,AttributeName:"minecraft:generic.attack_damage",Operation:0,Slot:"mainhand",UUID:[I;-43852763,1861435685,-1714780084,1341114750]}],CustomModelData:12,Damage:0} 1
