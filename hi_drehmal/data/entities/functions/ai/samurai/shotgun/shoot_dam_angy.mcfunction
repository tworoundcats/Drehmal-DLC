# 1 PLAYER
execute if score playercount playercount matches ..1 unless entity @s[scores={blocking3=..4,blocked=1..}] run damage @s 16 minecraft:azoth
...
# 2-3 PLAYERS
execute if score playercount playercount matches 2..3 unless entity @s[scores={blocking3=..4,blocked=1..}] run damage @s 17 minecraft:azoth
...
# 4-5 PLAYERS
execute if score playercount playercount matches 4..5 unless entity @s[scores={blocking3=..4,blocked=1..}] run damage @s 18 minecraft:azoth
...
# 6-7 PLAYERS
execute if score playercount playercount matches 6..7 unless entity @s[scores={blocking3=..4,blocked=1..}] run damage @s 19 minecraft:azoth
...
# 8+ PLAYERS
execute if score playercount playercount matches 8.. unless entity @s[scores={blocking3=..4,blocked=1..}] run damage @s 20 minecraft:azoth
