# 1 PLAYER
execute if score playercount playercount matches ..1 run damage @s 16 minecraft:ysold/hole
execute if score playercount playercount matches ..1 run effect give @s minecraft:wither 2 20 true

# 2-3 PLAYERS
execute if score playercount playercount matches 2..3 run damage @s 17 minecraft:ysold/hole
execute if score playercount playercount matches 2..3 run effect give @s minecraft:wither 2 21 true

# 4-5 PLAYERS
execute if score playercount playercount matches 4..5 run damage @s 18 minecraft:ysold/hole
execute if score playercount playercount matches 4..5 run effect give @s minecraft:wither 2 22 true

# 6-7 PLAYERS
execute if score playercount playercount matches 6..7 run damage @s 19 minecraft:ysold/hole
execute if score playercount playercount matches 6..7 run effect give @s minecraft:wither 2 23 true

# 8+ PLAYERS
execute if score playercount playercount matches 8.. run damage @s 20 minecraft:ysold/hole
