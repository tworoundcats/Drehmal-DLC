...
execute unless entity @s[tag=sam_angy] positioned ~-0.75 ~-1 ~-0.75 as @a[dx=0.5,dy=3,dz=0.5] run function entities:ai/samurai/slash_dam
execute if entity @s[tag=sam_angy] positioned ~-0.75 ~-1 ~-0.75 as @a[dx=0.5,dy=3,dz=0.5] run function entities:ai/samurai/slash_dam_angy
