...
execute unless score #DLC mastermode matches 1 run execute at @s positioned ~ ~-0.75 ~ if entity @a[distance=..1] run execute as @a[distance=..1] run damage @s 65 in_fire by @e[tag=rhalon,limit=1]
