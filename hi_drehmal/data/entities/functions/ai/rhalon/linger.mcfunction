...
execute unless score #DLC mastermode matches 1 run execute at @s if entity @a[distance=..2] run execute as @a[distance=..2] run damage @s 10 in_fire
execute unless score #DLC mastermode matches 1 run execute at @s if entity @a[distance=..2] run execute as @a[distance=..2] run damage @s 15 in_fire
