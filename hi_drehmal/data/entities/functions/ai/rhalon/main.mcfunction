...
execute as @s[tag=!swapped3] unless score #noswap2 bool matches 1 if score #rhalon_swap3 temp >= #rhalon temp run function entities:bosses/generals/swap_rhalon_6
...
execute unless score #DLC mastermode matches 1 run execute as @s[tag=unstoppable] at @s if entity @a[distance=..2] run execute as @a[distance=..2.5] run damage @s 25 fly_into_wall by @e[tag=rhalon,limit=1]
execute if score #DLC mastermode matches 1 run execute as @s[tag=unstoppable] at @s if entity @a[distance=..2] run execute as @a[distance=..2.5] run damage @s 35 fly_into_wall by @e[tag=rhalon,limit=1]
