...
execute unless score #DLC mastermode matches 1 run execute as @s[tag=unstoppable] at @s as @a[distance=..2.3] unless entity @s[scores={blocking3=..4,blocked=1..}] run damage @s 30 fly_into_wall by @e[tag=rhalon,limit=1]
execute unless score #DLC mastermode matches 1 run execute as @s[tag=unstoppable] at @s as @a[distance=..2.3] if entity @s[scores={blocking3=..4,blocked=1..}] run function players:items/reticent/main
execute if score #DLC mastermode matches 1 run execute as @s[tag=unstoppable] at @s as @a[distance=..2.3] unless entity @s[scores={blocking3=..4,blocked=1..}] run damage @s 40 fly_into_wall by @e[tag=rhalon,limit=1]
execute if score #DLC mastermode matches 1 run execute as @s[tag=unstoppable] at @s as @a[distance=..2.3] if entity @s[scores={blocking3=..4,blocked=1..}] run function players:items/reticent/main
