...
execute unless score #DLC mastermode matches 1 run execute as @s[tag=unstoppable] at @s if entity @a[distance=..2] run execute as @a[distance=..2] run damage @s 25 fly_into_wall by @e[tag=rhalon,limit=1]
execute if score #DLC mastermode matches 1 run execute as @s[tag=unstoppable] at @s if entity @a[distance=..2] run execute as @a[distance=..2] run damage @s 35 fly_into_wall by @e[tag=rhalon,limit=1]
