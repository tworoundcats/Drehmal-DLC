...
execute unless score #DLC mastermode matches 1 run execute at @s run execute as @a[distance=..5] if entity @s[scores={blocking3=..4,blocked=1..}] run function players:items/reticent/main
