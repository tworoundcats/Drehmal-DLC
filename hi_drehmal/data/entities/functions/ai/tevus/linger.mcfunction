...
execute unless score #DLC mastermode matches 1 run execute at @s if score @s num matches 20.. if entity @a[distance=..2] run execute as @a[distance=..2.5] unless entity @s[scores={blocking3=..4,blocked=1..}] run damage @s 30 in_fire by @e[tag=tevus,limit=1]
execute unless score #DLC mastermode matches 1 run execute at @s if score @s num matches 20.. if entity @a[distance=..2] run execute as @a[distance=..2.5] if entity @s[scores={blocking3=..4,blocked=1..}] run function players:items/reticent/main
execute unless score #DLC mastermode matches 1 run execute at @s if score @s num matches 20.. if entity @a[distance=..2] run execute as @a[distance=..2.5] unless entity @s[scores={blocking3=..4,blocked=1..}] run damage @s 40 in_fire by @e[tag=tevus,limit=1]
execute unless score #DLC mastermode matches 1 run execute at @s if score @s num matches 20.. if entity @a[distance=..2] run execute as @a[distance=..2.5] if entity @s[scores={blocking3=..4,blocked=1..}] run function players:items/reticent/main

execute unless score #DLC mastermode matches 1 unless score #tevus_active bool matches 1 run execute at @s if score @s num matches 20.. if entity @a[distance=..2] run execute as @a[distance=..2.5] unless entity @s[scores={blocking3=..4,blocked=1..}] run damage @s 30 in_fire
execute unless score #DLC mastermode matches 1 unless score #tevus_active bool matches 1 run execute at @s if score @s num matches 20.. if entity @a[distance=..2] run execute as @a[distance=..2.5] if entity @s[scores={blocking3=..4,blocked=1..}] run function players:items/reticent/main
execute if score #DLC mastermode matches 1 unless score #tevus_active bool matches 1 run execute at @s if score @s num matches 20.. if entity @a[distance=..2] run execute as @a[distance=..2.5] unless entity @s[scores={blocking3=..4,blocked=1..}] run damage @s 40 in_fire
execute if score #DLC mastermode matches 1 unless score #tevus_active bool matches 1 run execute at @s if score @s num matches 20.. if entity @a[distance=..2] run execute as @a[distance=..2.5] if entity @s[scores={blocking3=..4,blocked=1..}] run function players:items/reticent/main
