...
execute unless score #DLC mastermode matches 1 run execute at @s if score @s num matches 20.. if entity @a[distance=..2] run execute as @a[distance=..2] run damage @s 30 in_fire
execute unless score #DLC mastermode matches 1 run execute at @s if score @s num matches 20.. if entity @a[distance=..2] run execute as @a[distance=..2] run damage @s 40 in_fire
