...
execute if score #DLC mastermode matches 1 run schedule function entities:ai/tevus/attack1_16 4t
execute unless score #DLC mastermode matches 1 run schedule function entities:ai/tevus/attack1_20 4t
