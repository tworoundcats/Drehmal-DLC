...
execute if score @s ai_timer2 matches 5 run function entities:ai/fdry_shotgun/equip_gun
...
execute if score @s ai_timer2 matches 24 anchored eyes positioned ^ ^ ^ run function entities:ai/fdry_shotgun/shoot
execute if score @s ai_timer2 matches 34 run function entities:ai/fdry_shotgun/end_attack