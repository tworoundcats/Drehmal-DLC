...
execute as @s[scores={bleed=20}] unless entity @s[scores={blocking3=..4,blocked=1..}] run damage @s 2 generic
...
execute as @s[scores={bleed=40}] unless entity @s[scores={blocking3=..4,blocked=1..}] run damage @s 2 generic
