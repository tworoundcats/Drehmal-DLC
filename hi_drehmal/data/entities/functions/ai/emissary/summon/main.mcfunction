...
execute if score @s ai_ani matches 5 run execute as @e[tag=aj.emis.root] run function emis:animations/calldown/play
...
execute if score @s ai_ani matches 12 run function entities:ai/emissary/summon/spawn
execute if score @s ai_ani matches 80 run function entities:ai/emissary/summon/endphase