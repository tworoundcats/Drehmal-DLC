...
execute positioned ~-0.85 ~-0.85 ~-0.85 if entity @e[type=player,sort=nearest,dx=0,dy=0,dz=0] positioned ~0.9 ~0.9 ~0.9 if entity @e[type=player,dx=0,dy=0,dz=0] run function entities:ai/khive_zombie/particle_hit

particle minecraft:dust 1 0.8 0 1 ~ ~ ~ 0 0 0 0 1 force

execute at @s run teleport @s ^ ^ ^0.05
execute if score #loop temp matches 1.. unless score #done temp matches 1 at @s run function entities:ai/khive_zombie/particle_loop
