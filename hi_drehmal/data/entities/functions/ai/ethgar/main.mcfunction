...
execute as @s[tag=!swapped3] unless score #noswap2 bool matches 1 if score #ethgar_swap3 temp >= #ethgar temp run function entities:bosses/generals/swap_ethgar_6
