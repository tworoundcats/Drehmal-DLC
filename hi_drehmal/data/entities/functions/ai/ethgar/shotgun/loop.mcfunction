...
execute positioned ~0.01 ~0.01 ~0.01 as @a[dx=0,dy=0,dz=0] positioned ~-0.98 ~-0.98 ~-0.98 if entity @s[dx=0,dy=0,dz=0] run function entities:ai/ethgar/shotgun/shoot_dam
