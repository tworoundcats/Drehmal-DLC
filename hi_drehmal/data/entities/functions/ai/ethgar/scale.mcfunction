# 1 PLAYER
execute if score playercount playercount matches ..1 run bossbar set health3 max 300
...
# 2-3 PLAYERS
execute if score playercount playercount matches 2..3 run bossbar set health3 max 375
...
# 4-5 PLAYERS
execute if score playercount playercount matches 4..5 run bossbar set health3 max 450
...
# 6-7 PLAYERS
execute if score playercount playercount matches 6..7 run bossbar set health3 max 525
...
# 8+ PLAYERS
execute if score playercount playercount matches 8.. run bossbar set health3 max 600
...
# SYNC BOSSBAR
execute store result bossbar health3 value run bossbar get health3 max