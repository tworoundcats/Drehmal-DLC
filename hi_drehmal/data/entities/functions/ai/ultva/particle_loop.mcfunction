...
execute positioned ~ ~-1 ~ if entity @a[distance=..1] run function entities:ai/ultva/particle_hit

execute positioned ~ ~-1 ~ if entity @a[tag=temp.target,distance=..9] run tag @s add noai
execute positioned ~ ~-1 ~ unless entity @a[distance=..9] run kill @s[tag=noai]
