...
execute store result entity @s Motion[1] double 0.012 run scoreboard players get @s spm.y
execute store result entity @s Motion[2] double 0.012 run scoreboard players get @s spm.z

particle squid_ink ~ ~0.1 ~ 1 0.2 1 0 20
playsound simplyswords:dark_sword_parry player @a ~ ~ ~ 2 0
