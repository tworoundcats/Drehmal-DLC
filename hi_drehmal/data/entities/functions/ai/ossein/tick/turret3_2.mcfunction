...
execute if score #DLC mastermode matches 1 run summon mythicmetals:star_platinum_arrow ~ ~1.5 ~ {Tags:["calc_motion_arrow"], pickup:0b,damage:8d, crit:1b}
execute unless score #DLC mastermode matches 1 run summon mythicmetals:star_platinum_arrow ~ ~1.5 ~ {Tags:["calc_motion_arrow"], pickup:0b,damage:7d, crit:1b}
