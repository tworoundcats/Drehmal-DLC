execute if score @s ai_timer matches ..100 run particle dlc:marker ~ ~ ~ 0 0 0 1 0 force

execute unless score @s ai_timer matches 100.. positioned ^ ^ ^0.5 unless block ~ ~ ~ #core:empty run function particle:effects/red_x
