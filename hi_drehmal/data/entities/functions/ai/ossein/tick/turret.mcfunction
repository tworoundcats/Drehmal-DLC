...
execute at @s if entity @e[type=arrow,distance=..3,tag=!ossein_arrow] run kill @e[type=arrow,tag=sigma]
...
execute if score @s num matches 40 at @s as @a as @s run function entities:ai/ossein/tick/turret_pos
execute if score @s num matches 40 at @s anchored eyes positioned ^ ^ ^0.5 facing entity @a[tag=target1] feet run function entities:ai/ossein/tick/turret2
execute if score @s num matches 40 at @s anchored eyes positioned ^ ^ ^0.5 facing entity @a[tag=target2] feet run function entities:ai/ossein/tick/turret2
...
execute if score @s[tag=ossein_turret2] num matches 55 at @s run function entities:ai/ossein/tick/turret3_2
