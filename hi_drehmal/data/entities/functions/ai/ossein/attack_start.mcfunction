...
item replace entity @s weapon.mainhand with minecraft:netherite_sword{Mythic:1b,weapon_attributes:'{"parent":"minecraft:calamity"}',Calamity:1b,CustomModelData:1}
