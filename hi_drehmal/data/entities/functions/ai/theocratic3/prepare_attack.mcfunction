...
execute if score @s ai_timer2 matches 27 if entity @a[distance=..4] run function entities:ai/theocratic3/jump_back
execute if score @s ai_timer2 matches 27 if entity @a[distance=4..] run function entities:ai/theocratic3/jump
