...
execute in minecraft:lodahr as @a[predicate=players:lodahr,x=-424,y=45,z=560,distance=..150,tag=primal_journey] run schedule function dlc:primal_journey/win 5s
