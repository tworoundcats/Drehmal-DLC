...
execute if entity @e[tag=lampjaw,sort=nearest,limit=1] run damage @s 20 generic by @e[tag=lampjaw,sort=nearest,limit=1]
execute unless entity @e[tag=lampjaw,sort=nearest,limit=1] run damage @s 15 khivewrath by @e[tag=mb_run_blind,sort=nearest,limit=1]
