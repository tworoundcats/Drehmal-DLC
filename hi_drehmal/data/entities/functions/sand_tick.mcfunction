...
execute if entity @s[tag=magma_block] run function entities:ai/tevus/projectile_main
execute if entity @s[tag=wrath] run function dlc:mobs/primal_wrath/projectile_main
