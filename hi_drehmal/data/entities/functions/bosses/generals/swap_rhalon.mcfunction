...
scoreboard players set #swap temp 1
...
execute if score #ethgar_active bool matches 1 if score #tevus_active bool matches 1 if score #tevus_swap temp >= #tevus temp if score #ethgar_swap temp >= #ethgar temp run scoreboard players set #generals int 3
...
execute unless score #generals int matches 3 run tp @s 27365 161 747 facing entity @p
execute unless score #generals int matches 3 run schedule function entities:bosses/generals/align_rhalon 10t



execute if score #generals int matches 0 run tellraw @a[predicate=players:in_generals_arena] ["",{"text":"["},{"text":"Rhalon, the First General","color":"dark_red"},{"text":"]"},{"text":" DECIMATE THEM, TEVUS!"}]
execute if score #generals int matches 1 run tellraw @a[predicate=players:in_generals_arena] ["",{"text":"["},{"text":"Rhalon, the First General","color":"dark_red"},{"text":"]"},{"text":" MAKE THEM SUFFER, ETHGAR!"}]
...
execute if score #generals int matches 3 run function entities:bosses/generals/swap_rhalon_3 