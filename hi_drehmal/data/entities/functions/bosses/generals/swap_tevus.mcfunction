...
execute unless score #generals int matches 3 run tp @s 27365 161 744 facing entity @p
execute unless score #generals int matches 3 run schedule function entities:bosses/generals/align_tevus 10t
