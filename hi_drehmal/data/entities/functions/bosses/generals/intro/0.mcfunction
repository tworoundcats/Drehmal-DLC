...
execute positioned -2849.65 41.00 5331.37 as @a[distance=..16] run tag @s add tempdeaths
execute positioned -2849.65 41.00 5331.37 as @a[distance=..16] run tag @s add generalsdeaths
