...
execute if score #ossein_dead? bool matches 1 as @a at @s if score @s settings.punish matches 2 positioned 26302.32 193.00 154.45 as @a[distance=..4] run tag @s add ossein.nohit_reward
...
summon marker 26303.0 196.00 154.5 {Tags:["ossein_default"]}
