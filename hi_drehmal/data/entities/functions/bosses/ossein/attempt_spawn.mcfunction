...
execute unless score #ossein_active? bool matches 1 if score #ossein_dead? bool matches 1 unless score #ossein_dead?2 bool matches 1 run function entities:bosses/ossein/spawnboss
