...
execute if score #dia_lunbase timer matches 215 positioned 3178 72.00 -984 as @a[distance=..10] run damage @s[scores={blocking3=..4,blocked=1..}] 300 minecraft:primalenergy
