...
execute if score #returnportal timer matches 1..40 run particle squid_ink 782.50 4.00 564.53 0.1 0.1 0.1 0 10
...
execute if score #returnportal timer matches 40..80 run particle squid_ink 782.50 4.00 564.53 0.2 0.2 0.2 0 10
...
execute if score #returnportal timer matches 80..120 run particle squid_ink 782.50 4.00 564.53 0.3 0.3 0.3 0 10
...
execute if score #returnportal timer matches 120..160 run particle squid_ink 782.50 4.00 564.53 0.4 0.4 0.4 0 10
...
execute if score #returnportal timer matches 160..200 run particle squid_ink 782.50 4.00 564.53 0.5 0.5 0.5 0 10
...
execute if score #returnportal timer matches 199 run particle end_rod 782.50 4.00 564.53 0 0 0 0.15 50
