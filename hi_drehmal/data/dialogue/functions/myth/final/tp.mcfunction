...
execute if score @s finaltp matches 40 positioned ~ ~ ~ run damage @s[scores={blocking3=..4,blocked=1..}] 1
execute if score @s finaltp matches 80 positioned ~ ~ ~ run damage @s[scores={blocking3=..4,blocked=1..}] 1
execute if score @s finaltp matches 120 positioned ~ ~ ~ run damage @s[scores={blocking3=..4,blocked=1..}] 1
execute if score @s finaltp matches 140 positioned ~ ~ ~ run damage @s[scores={blocking3=..4,blocked=1..}] 1
execute if score @s finaltp matches 160 positioned ~ ~ ~ run damage @s[scores={blocking3=..4,blocked=1..}] 1
execute if score @s finaltp matches 170 positioned ~ ~ ~ run damage @s[scores={blocking3=..4,blocked=1..}] 1
execute if score @s finaltp matches 180 positioned ~ ~ ~ run damage @s[scores={blocking3=..4,blocked=1..}] 1
execute if score @s finaltp matches 185 positioned ~ ~ ~ run damage @s[scores={blocking3=..4,blocked=1..}] 1
execute if score @s finaltp matches 190 positioned ~ ~ ~ run damage @s[scores={blocking3=..4,blocked=1..}] 1
execute if score @s finaltp matches 193 positioned ~ ~ ~ run damage @s[scores={blocking3=..4,blocked=1..}] 1
execute if score @s finaltp matches 196 positioned ~ ~ ~ run damage @s[scores={blocking3=..4,blocked=1..}] 1
execute if score @s finaltp matches 198 positioned ~ ~ ~ run damage @s[scores={blocking3=..4,blocked=1..}] 1
execute if score @s finaltp matches 199 positioned ~ ~ ~ run damage @s[scores={blocking3=..4,blocked=1..}] 1
