...
execute if score #5T timer matches 0 positioned 3176.44 61.08 -987.44 as @a[distance=..1] run damage @s[scores={blocking3=..4,blocked=1..}] 2 minecraft:rubber_nocd

execute if score #5T timer matches 0 positioned 3178.54 60.08 -981.56 as @a[distance=..1] run damage @s[scores={blocking3=..4,blocked=1..}] 2 minecraft:rubber_nocd