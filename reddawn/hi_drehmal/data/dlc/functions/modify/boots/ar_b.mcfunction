...
execute as @s[tag=!finish] run schedule function dlc:modify/boots/ar_b 3.5s
data modify block 1000003 63 1000002 front_text.messages[1] set value '[{"nbt":"ArmorItems[0].tag.display.Name","entity":"@e[type=armor_stand,tag=ar,limit=1]","interpret":true},{"text":"⁺ᴀʀ"}]'
data modify entity @s ArmorItems[0].tag.display.Name set from block 1000003 63 1000002 front_text.messages[1]
item modify entity @s armor.feet dlc:boots/ar_modify1
