...
execute if score @s buff_ani matches 52 align xyz run playsound minecraft:dcustom.block.beacon.activate block @a[dx=1,dy=2,dz=1] ~ ~ ~ 1 0.8
...
execute if score @s buff_ani matches 30 align xyz run playsound minecraft:dcustom.entity.zombie_villager.cure block @a[dx=1,dy=2,dz=1]
...
execute if score @s buff_ani matches 10 unless score @s fdoor_old matches 1 run playsound minecraft:dcustom.block.piston.contract block @a
