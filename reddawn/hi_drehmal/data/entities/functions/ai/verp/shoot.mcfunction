...
execute positioned ^ ^ ^ facing ^ ^ ^6 run function entities:ai/verp/loop
scoreboard players set #loop temp 55
execute positioned ^ ^0.2 ^ facing ^ ^0.8 ^5.9 run function entities:ai/verp/loop
scoreboard players set #loop temp 55
execute positioned ^ ^-0.2 ^ facing ^ ^-0.8 ^5.9 run function entities:ai/verp/loop
scoreboard players set #loop temp 55
execute positioned ^0.2 ^ ^ facing ^0.8 ^ ^5.9 run function entities:ai/verp/loop
...
execute positioned ^-0.2 ^ ^ facing ^-0.8 ^ ^5.9 run function entities:ai/verp/loop
scoreboard players set #loop temp 55
execute positioned ^0.14 ^0.14 ^ facing ^0.57 ^0.57 ^5.9 run function entities:ai/verp/loop
scoreboard players set #loop temp 55
execute positioned ^-0.14 ^0.14 ^ facing ^-0.57 ^0.57 ^5.9 run function entities:ai/verp/loop
scoreboard players set #loop temp 55
execute positioned ^0.14 ^-0.14 ^ facing ^0.57 ^-0.57 ^5.9 run function entities:ai/verp/loop
