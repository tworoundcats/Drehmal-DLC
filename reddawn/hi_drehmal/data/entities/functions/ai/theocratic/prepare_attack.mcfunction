...
execute if score @s ai_timer2 matches 27 if entity @a[distance=..5] run function entities:ai/theocratic/amain
execute if score @s ai_timer2 matches 27 if entity @a[distance=5..] run function entities:ai/theocratic/jump
