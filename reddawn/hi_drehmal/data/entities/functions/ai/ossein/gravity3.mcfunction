execute unless score #low_particles? bool matches 1 run execute as @a[predicate=players:locations/ossein_arena] at @s run particle bosses_of_mass_destruction:obsidilith_spike ~ ~8 ~ 0 0 0 1 100
...
#execute as @a[predicate=players:locations/ossein_arena] at @s run gravity set_base_direction west
execute as @a[predicate=players:locations/ossein_arena] at @s run effect give @s resistance 4 1 true

schedule function entities:ai/ossein/gravity4 3s