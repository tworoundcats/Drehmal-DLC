...
execute if score @s ai_timer matches 55 run playsound minecraft:block.respawn_anchor.deplete hostile @p ~ ~ ~ 3 1.2
execute if score @s ai_timer matches 58 run playsound minecraft:block.respawn_anchor.deplete hostile @p ~ ~ ~ 3 0
