...
execute positioned 26475.47 141.08 -55.00 run playsound minecraft:dcustom.block.amethyst_block.chime master @a ~ ~ ~ 25 1
execute positioned 26475.47 141.08 -55.00 run playsound minecraft:dcustom.block.amethyst_block.chime master @a ~ ~ ~ 25 2
execute positioned 26475.47 141.08 -55.00 run playsound minecraft:dcustom.block.amethyst_block.chime master @a ~ ~ ~ 25 0
execute positioned 26475.47 141.08 -55.00 run playsound minecraft:block.enchantment_table.use master @a ~ ~ ~ 5 2
execute positioned 26475.47 141.08 -55.00 run playsound minecraft:dcustom.block.amethyst_cluster.place master @a ~ ~ ~ 5 0
execute positioned 26475.47 141.08 -55.00 run playsound minecraft:dcustom.block.amethyst_cluster.place master @a ~ ~ ~ 5 2
execute positioned 26475.47 141.08 -55.00 run playsound minecraft:dcustom.block.amethyst_cluster.place master @a ~ ~ ~ 5 1
