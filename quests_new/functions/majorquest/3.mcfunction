execute at @e[tag=major] run tellraw @a[distance=..20] ["",{"text":"<","color":"white"},{"text":"Major","color":"light_purple"},{"text":"> ","color":"white"},{"text":"Number "},{"text":"three","color":"yellow"},{"text":"! This might've been here since the land was first formed! Thank you so much!"}]
