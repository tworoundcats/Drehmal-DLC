execute at @e[tag=major] run tellraw @a[distance=..20] ["",{"text":"<","color":"white"},{"text":"Major","color":"light_purple"},{"text":"> ","color":"white"},{"text":"Here, for your troubles. You seem like more of an adventurer than myself, so you can have my old sword. Thank you again!"}]
