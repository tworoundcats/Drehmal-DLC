...
execute at @e[tag=gragas] run tellraw @a[distance=..20] ["",{"text":"<"},{"text":"Gragas","color":"red"},{"text":"> Ugh... need some grog... you're back! Let's see what the fuss is about, then!"}]
